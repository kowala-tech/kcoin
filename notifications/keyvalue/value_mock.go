...
func (mock *ValueMock) GetInt64() (int64, error) {
	if mock.GetInt64Func == nil {
		panic("moq: ValueMock.GetInt64Func is nil but Value.GetInt64 was just called")
	}
	callInfo := struct {
	}{}
...
func (mock *ValueMock) GetString() (string, error) {
	if mock.GetStringFunc == nil {
		panic("moq: ValueMock.GetStringFunc is nil but Value.GetString was just called")
	}
	callInfo := struct {
	}{}
...
func (mock *ValueMock) PutInt64(value int64) error {
	if mock.PutInt64Func == nil {
		panic("moq: ValueMock.PutInt64Func is nil but Value.PutInt64 was just called")
	}
	callInfo := struct {
		Value int64
	}{
...
func (mock *ValueMock) PutString(value string) error {
	if mock.PutStringFunc == nil {
		panic("moq: ValueMock.PutStringFunc is nil but Value.PutString was just called")
	}
	callInfo := struct {
		Value string
	}{
