...
func (mock *BlockchainMock) OnBlock(in1 BlockHandler) error {
	if mock.OnBlockFunc == nil {
		panic("moq: BlockchainMock.OnBlockFunc is nil but Blockchain.OnBlock was just called")
	}
	callInfo := struct {
		In1 BlockHandler
	}{
...
func (mock *BlockchainMock) Seek(in1 *big.Int) error {
	if mock.SeekFunc == nil {
		panic("moq: BlockchainMock.SeekFunc is nil but Blockchain.Seek was just called")
	}
	callInfo := struct {
		In1 *big.Int
	}{
...
func (mock *BlockchainMock) Start() error {
	if mock.StartFunc == nil {
		panic("moq: BlockchainMock.StartFunc is nil but Blockchain.Start was just called")
	}
	callInfo := struct {
	}{}
...
func (mock *BlockchainMock) Stop() {
	if mock.StopFunc == nil {
		panic("moq: BlockchainMock.StopFunc is nil but Blockchain.Stop was just called")
	}
	callInfo := struct {
	}{}
