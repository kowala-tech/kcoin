...
func (mock *SubscriberMock) AddHandler(in1 MessageHandler) {
	if mock.AddHandlerFunc == nil {
		panic("moq: SubscriberMock.AddHandlerFunc is nil but Subscriber.AddHandler was just called")
	}
	callInfo := struct {
		In1 MessageHandler
	}{
...
func (mock *SubscriberMock) Start() error {
	if mock.StartFunc == nil {
		panic("moq: SubscriberMock.StartFunc is nil but Subscriber.Start was just called")
	}
	callInfo := struct {
	}{}
...
func (mock *SubscriberMock) Stop() {
	if mock.StopFunc == nil {
		panic("moq: SubscriberMock.StopFunc is nil but Subscriber.Stop was just called")
	}
	callInfo := struct {
	}{}
