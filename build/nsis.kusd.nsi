...
# 1. install kusd for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for kusd
# 5. create kusd, attach and uninstall start menu entries
...
function .onInit
  # make vars are global for all users since kusd is installed global
