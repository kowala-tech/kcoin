...
dev_bootnode_docker_image:
	docker build -t --build-arg CI --build-arg DRONE --build-arg DRONE_REPO --build-arg DRONE_COMMIT_SHA --build-arg DRONE_COMMIT_BRANCH --build-arg DRONE_TAG --build-arg DRONE_BUILD_NUMBER --build-arg DRONE_BUILD_EVENT kowalatech/bootnode:dev -f client/release/bootnode.Dockerfile .

.PHONY: dev_faucet_docker_image
dev_faucet_docker_image:
	docker build -t --build-arg CI --build-arg DRONE --build-arg DRONE_REPO --build-arg DRONE_COMMIT_SHA --build-arg DRONE_COMMIT_BRANCH --build-arg DRONE_TAG --build-arg DRONE_BUILD_NUMBER --build-arg DRONE_BUILD_EVENT kowalatech/faucet:dev -f client/release/faucet.Dockerfile .

.PHONY: dev_wallet_backend_docker_image
dev_wallet_backend_docker_image:
	docker build -t --build-arg CI --build-arg DRONE --build-arg DRONE_REPO --build-arg DRONE_COMMIT_SHA --build-arg DRONE_COMMIT_BRANCH --build-arg DRONE_TAG --build-arg DRONE_BUILD_NUMBER --build-arg DRONE_BUILD_EVENT kowalatech/wallet_backend:dev -f wallet-backend/Dockerfile .

.PHONY: dev_transactions_persistance_docker_image
dev_transactions_persistance_docker_image:
	docker build -t --build-arg CI --build-arg DRONE --build-arg DRONE_REPO --build-arg DRONE_COMMIT_SHA --build-arg DRONE_COMMIT_BRANCH --build-arg DRONE_TAG --build-arg DRONE_BUILD_NUMBER --build-arg DRONE_BUILD_EVENT kowalatech/transactions_persistance:dev -f notifications/transactions_db_synchronize.Dockerfile .

.PHONY: dev_transactions_publisher_docker_image
dev_transactions_publisher_docker_image:
	docker build -t --build-arg CI --build-arg DRONE --build-arg DRONE_REPO --build-arg DRONE_COMMIT_SHA --build-arg DRONE_COMMIT_BRANCH --build-arg DRONE_TAG --build-arg DRONE_BUILD_NUMBER --build-arg DRONE_BUILD_EVENT kowalatech/transactions_publisher:dev -f notifications/transactions_publisher.Dockerfile .

.PHONY: dev_backend_api_docker_image
dev_backend_api_docker_image:
	docker build -t --build-arg CI --build-arg DRONE --build-arg DRONE_REPO --build-arg DRONE_COMMIT_SHA --build-arg DRONE_COMMIT_BRANCH --build-arg DRONE_TAG --build-arg DRONE_BUILD_NUMBER --build-arg DRONE_BUILD_EVENT kowalatech/backend_api:dev -f notifications/api.Dockerfile .

.PHONY: dev_explorer_docker_image
dev_explorer_docker_image:
	docker build -t --build-arg CI --build-arg DRONE --build-arg DRONE_REPO --build-arg DRONE_COMMIT_SHA --build-arg DRONE_COMMIT_BRANCH --build-arg DRONE_TAG --build-arg DRONE_BUILD_NUMBER --build-arg DRONE_BUILD_EVENT kowalatech/kexplorer -f explorer/web.Dockerfile .
