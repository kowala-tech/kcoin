...
const PriceOracleContractABI = `[{"constant":true,"inputs":[],"name":"cryptoDecimals","outputs":[{"name":"","type":"uint8"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[{"name":"fiatAmount","type":"uint256"}],"name":"priceForFiat","outputs":[{"name":"cryptoAmount","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[],"name":"fiatName","outputs":[{"name":"","type":"string"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[],"name":"fiatSymbol","outputs":[{"name":"","type":"string"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[],"name":"cryptoSymbol","outputs":[{"name":"","type":"string"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[{"name":"cryptoAmount","type":"uint256"}],"name":"priceForCrypto","outputs":[{"name":"fiatAmount","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[],"name":"cryptoName","outputs":[{"name":"","type":"string"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"name":"addr","type":"address"}],"name":"transferOwnership","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[],"name":"fiatDecimals","outputs":[{"name":"","type":"uint8"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"name":"cryptoAmount","type":"uint256"},{"name":"fiatAmount","type":"uint256"}],"name":"setPrice","outputs":[{"name":"success","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"},{"inputs":[{"name":"cryptoAmount","type":"uint256"},{"name":"fiatAmount","type":"uint256"}],"payable":false,"stateMutability":"nonpayable","type":"constructor"},{"anonymous":false,"inputs":[{"indexed":false,"name":"cryptoPrice","type":"uint256"},{"indexed":false,"name":"fiatPrice","type":"uint256"}],"name":"NewPrice","type":"event"},{"anonymous":false,"inputs":[{"indexed":false,"name":"oldAddr","type":"address"},{"indexed":false,"name":"newAddr","type":"address"}],"name":"OwnershipTransfer","type":"event"}]`

// PriceOracleContractBin is the compiled bytecode used for deploying new contracts.
const PriceOracleContractBin = ``

// DeployPriceOracleContract deploys a new Ethereum contract, binding an instance of PriceOracleContract to it.
func DeployPriceOracleContract(auth *bind.TransactOpts, backend bind.ContractBackend, cryptoAmount *big.Int, fiatAmount *big.Int) (common.Address, *types.Transaction, *PriceOracleContract, error) {
	parsed, err := abi.JSON(strings.NewReader(PriceOracleContractABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(PriceOracleContractBin), backend, cryptoAmount, fiatAmount)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
...
func NewPriceOracleContract(address common.Address, backend bind.ContractBackend) (*PriceOracleContract, error) {
	contract, err := bindPriceOracleContract(address, backend.(bind.ContractCaller), backend.(bind.ContractTransactor))
	if err != nil {
		return nil, err
	}
...
//
// Solidity: function priceForCrypto(cryptoAmount uint256) constant returns(fiatAmount uint256)
func (_PriceOracleContract *PriceOracleContractCaller) PriceForCrypto(opts *bind.CallOpts, cryptoAmount *big.Int) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
	err := _PriceOracleContract.contract.Call(opts, out, "priceForCrypto", cryptoAmount)
	return *ret0, err
}
...
//
// Solidity: function priceForCrypto(cryptoAmount uint256) constant returns(fiatAmount uint256)
func (_PriceOracleContract *PriceOracleContractSession) PriceForCrypto(cryptoAmount *big.Int) (*big.Int, error) {
	return _PriceOracleContract.Contract.PriceForCrypto(&_PriceOracleContract.CallOpts, cryptoAmount)
}

// PriceForCrypto is a free data retrieval call binding the contract method 0x6857e1c5.
//
// Solidity: function priceForCrypto(cryptoAmount uint256) constant returns(fiatAmount uint256)
func (_PriceOracleContract *PriceOracleContractCallerSession) PriceForCrypto(cryptoAmount *big.Int) (*big.Int, error) {
	return _PriceOracleContract.Contract.PriceForCrypto(&_PriceOracleContract.CallOpts, cryptoAmount)
}

// PriceForFiat is a free data retrieval call binding the contract method 0x0c272196.
//
// Solidity: function priceForFiat(fiatAmount uint256) constant returns(cryptoAmount uint256)
func (_PriceOracleContract *PriceOracleContractCaller) PriceForFiat(opts *bind.CallOpts, fiatAmount *big.Int) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
	err := _PriceOracleContract.contract.Call(opts, out, "priceForFiat", fiatAmount)
	return *ret0, err
}
...
//
// Solidity: function priceForFiat(fiatAmount uint256) constant returns(cryptoAmount uint256)
func (_PriceOracleContract *PriceOracleContractSession) PriceForFiat(fiatAmount *big.Int) (*big.Int, error) {
	return _PriceOracleContract.Contract.PriceForFiat(&_PriceOracleContract.CallOpts, fiatAmount)
}

// PriceForFiat is a free data retrieval call binding the contract method 0x0c272196.
//
// Solidity: function priceForFiat(fiatAmount uint256) constant returns(cryptoAmount uint256)
func (_PriceOracleContract *PriceOracleContractCallerSession) PriceForFiat(fiatAmount *big.Int) (*big.Int, error) {
	return _PriceOracleContract.Contract.PriceForFiat(&_PriceOracleContract.CallOpts, fiatAmount)
}

// SetPrice is a paid mutator transaction binding the contract method 0xf7d97577.
//
// Solidity: function setPrice(cryptoAmount uint256, fiatAmount uint256) returns(success bool)
func (_PriceOracleContract *PriceOracleContractTransactor) SetPrice(opts *bind.TransactOpts, cryptoAmount *big.Int, fiatAmount *big.Int) (*types.Transaction, error) {
	return _PriceOracleContract.contract.Transact(opts, "setPrice", cryptoAmount, fiatAmount)
}

// SetPrice is a paid mutator transaction binding the contract method 0xf7d97577.
//
// Solidity: function setPrice(cryptoAmount uint256, fiatAmount uint256) returns(success bool)
func (_PriceOracleContract *PriceOracleContractSession) SetPrice(cryptoAmount *big.Int, fiatAmount *big.Int) (*types.Transaction, error) {
	return _PriceOracleContract.Contract.SetPrice(&_PriceOracleContract.TransactOpts, cryptoAmount, fiatAmount)
}

// SetPrice is a paid mutator transaction binding the contract method 0xf7d97577.
//
// Solidity: function setPrice(cryptoAmount uint256, fiatAmount uint256) returns(success bool)
func (_PriceOracleContract *PriceOracleContractTransactorSession) SetPrice(cryptoAmount *big.Int, fiatAmount *big.Int) (*types.Transaction, error) {
	return _PriceOracleContract.Contract.SetPrice(&_PriceOracleContract.TransactOpts, cryptoAmount, fiatAmount)
}
