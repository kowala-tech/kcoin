...
/**
 * @title OracleManager
 * @dev The Election contract manages the oracles and provides basic functions
 * for price submission and session management.
 */
contract OracleManager is Ownable {
    ...
    function registerOracle() public payable onlyNewCandidate onlyWithMinDeposit {
        if (!_hasAvailability()) {
    ...
    function deregisterOracle() public onlyOracle {
    ...
    function submitPrice(uint price) public onlyOracle {
