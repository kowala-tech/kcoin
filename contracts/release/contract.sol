...
// versions of the go-ethereum implementation. Its goal is to allow kcoin to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new kcoin releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular kcoin release
  struct Version {
