...
// ValidatorManager is a paid mutator transaction binding the contract method 0x68eca649.
//
// Solidity: function ValidatorManager(_baseDeposit uint256, _maxValidators uint256, _unbondingPeriod uint256, _genesis address) returns()
func (_ValidatorManager *ValidatorManagerTransactor) ValidatorManager(opts *bind.TransactOpts, _baseDeposit *big.Int, _maxValidators *big.Int, _unbondingPeriod *big.Int, _genesis common.Address) (*types.Transaction, error) {
	return _ValidatorManager.contract.Transact(opts, "ValidatorManager", _baseDeposit, _maxValidators, _unbondingPeriod, _genesis)
}

// ValidatorManager is a paid mutator transaction binding the contract method 0x68eca649.
//
// Solidity: function ValidatorManager(_baseDeposit uint256, _maxValidators uint256, _unbondingPeriod uint256, _genesis address) returns()
func (_ValidatorManager *ValidatorManagerSession) ValidatorManager(_baseDeposit *big.Int, _maxValidators *big.Int, _unbondingPeriod *big.Int, _genesis common.Address) (*types.Transaction, error) {
	return _ValidatorManager.Contract.ValidatorManager(&_ValidatorManager.TransactOpts, _baseDeposit, _maxValidators, _unbondingPeriod, _genesis)
}

// ValidatorManager is a paid mutator transaction binding the contract method 0x68eca649.
//
// Solidity: function ValidatorManager(_baseDeposit uint256, _maxValidators uint256, _unbondingPeriod uint256, _genesis address) returns()
func (_ValidatorManager *ValidatorManagerTransactorSession) ValidatorManager(_baseDeposit *big.Int, _maxValidators *big.Int, _unbondingPeriod *big.Int, _genesis common.Address) (*types.Transaction, error) {
	return _ValidatorManager.Contract.ValidatorManager(&_ValidatorManager.TransactOpts, _baseDeposit, _maxValidators, _unbondingPeriod, _genesis)
}
