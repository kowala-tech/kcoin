...
Contracts play a central role in Kowala - the state of all accounts is the state of the Kowala network which is updated with every block.
The Kowala dev team is currently focused and actively improving contracts concerned with the consensus validation, price stabilisation and rewards.
...
* network/contracts/network.sol - consensus validators / slashing rules contract
* network/contracts/mtoken.sol - mtoken contract
* network/contracts/kUSD.sol - kUSD contract
* network/contracts/price_oracle.sol - oracle prices
