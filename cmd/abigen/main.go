...
import (
	...
	"github.com/kowala-tech/kUSD/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the KUSD contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the KUSD contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the KUSD contract Solidity source to build and bind")
