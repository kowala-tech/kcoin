...
func TestConsoleWelcome(t *testing.T) {
	...
	kusd.SetTemplateFunc("goos", func() string { return runtime.GOOS })
	kusd.SetTemplateFunc("goarch", func() string { return runtime.GOARCH })
	kusd.SetTemplateFunc("gover", runtime.Version)
	kusd.SetTemplateFunc("kusdver", func() string { return params.Version })
	kusd.SetTemplateFunc("niltime", func() string { return time.Unix(0, 0).Format(time.RFC1123) })
	kusd.SetTemplateFunc("apis", func() string { return ipcAPIs })
