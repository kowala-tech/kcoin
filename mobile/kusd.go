...
// NodeConfig represents the collection of configuration values to fine tune the kusd
...
// Node represents a kusd Ethereum node instance.
type Node struct {
	node *node.Node
}

// NewNode creates and configures a new kusd node.
