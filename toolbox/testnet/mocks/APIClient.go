...
import container "docker.io/go-docker/api/types/container"
import context "context"

import events "docker.io/go-docker/api/types/events"
import filters "docker.io/go-docker/api/types/filters"
import image "docker.io/go-docker/api/types/image"
import io "io"
import mock "github.com/stretchr/testify/mock"
import net "net"
import network "docker.io/go-docker/api/types/network"
import registry "docker.io/go-docker/api/types/registry"
import swarm "docker.io/go-docker/api/types/swarm"
import time "time"
import types "docker.io/go-docker/api/types"
import volume "docker.io/go-docker/api/types/volume"
...
func (_m *APIClient) NetworkInspect(ctx context.Context, networkID string, options types.NetworkInspectOptions) (types.NetworkResource, error) {
...
// NetworkInspectWithRaw provides a mock function with given fields: ctx, networkID, options
func (_m *APIClient) NetworkInspectWithRaw(ctx context.Context, networkID string, options types.NetworkInspectOptions) (types.NetworkResource, []byte, error) {
	ret := _m.Called(ctx, networkID, options)
