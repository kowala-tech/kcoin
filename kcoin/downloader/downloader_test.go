...
type downloadTester struct {
	...
	stateDb kcoindb.Database // Database used by the tester for syncing from peers
	peerDb  kcoindb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	testdb, _ := kcoindb.NewMemDatabase()
	...
	tester.stateDb, _ = kcoindb.NewMemDatabase()
