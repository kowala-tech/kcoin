...
func CreateConsensusEngine(ctx *node.ServiceContext, config *Config, chainConfig *params.ChainConfig, db database.Database) engine.Engine {
...
func (s *Kowala) ChainDb() database.Database         { return s.chainDb }
