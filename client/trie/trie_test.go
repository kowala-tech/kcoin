...
// Used for testing
func newEmpty() *Trie {
	trie, _ := New(common.Hash{}, NewDatabase(kcoindb.NewMemDatabase()))
	return trie
}
...
func TestMissingRoot(t *testing.T) {
	trie, err := New(common.HexToHash("0beec7b5ea3f0fdbc95d0dd47f3c5bc275da8a33"), NewDatabase(kcoindb.NewMemDatabase()))
	if trie != nil {
...
func tempDB() (string, *Database) {
	...
	diskdb, err := kcoindb.NewLDBDatabase(dir, 256, 0)
	if err != nil {
