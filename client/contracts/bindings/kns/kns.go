...
//go:generate solc --allow-paths ., --combined-json bin-runtime,srcmap-runtime --overwrite -o build/registrar-combined zos-lib/=../../truffle/node_modules/zos-lib/ ../../truffle/contracts/kns/FIFSRegistrar.sol
