...
//go:generate solc --allow-paths ., --abi --bin --overwrite --libraries NameHash:0x2b0D8ac41bD7aF24160c1F3C5430F496116b2292 -o build github.com/kowala-tech/kcoin/client/contracts/=../../truffle/contracts openzeppelin-solidity/=../../../truffle/node_modules/openzeppelin-solidity/ zos-lib/=../../../truffle/node_modules/zos-lib/ ../../../truffle/contracts/oracle/OracleMgr.sol
//go:generate ../../../../build/bin/abigen -abi build/OracleMgr.abi -bin build/OracleMgr.bin -pkg testfiles -type OracleMgr -out ./gen_oracle.go
...
//go:generate ../../../../build/bin/abigen -abi build/ExchangeMgr.abi -bin build/ExchangeMgr.bin -pkg testfiles -type ExchangeMgr -out ./gen_exchange.go
