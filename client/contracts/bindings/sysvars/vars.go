...
//go:generate ../../../build/bin/abigen -abi build/SystemVars.abi -bin build/SystemVars.bin -srcmap build/combined.json -pkg sysvars -type SystemVars -out ./gen_systemvars.go
