...
//     // when
//     await this.registrar.register(web3.sha3('validator'), accounts[0], { from: accounts[1] });
//     // then
...
//     // when
//     await this.resolver.setAddr(namehash('validator.kowala'), validator.address, { from: accounts[0] });
