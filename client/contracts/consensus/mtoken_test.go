...
import (
	...
	"github.com/kowala-tech/kcoin/client/contracts/consensus/testfiles"
...
var (
	...
	miningTokenCap      = new(big.Int).Mul(new(big.Int).SetUint64(1073741824), new(big.Int).SetUint64(params.KUSD)) // 1073741824 mUSD
