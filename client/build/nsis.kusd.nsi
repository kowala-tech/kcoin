...
# 1. install kcoin for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for kcoin
# 5. create kcoin, attach and uninstall start menu entries
...
!define GROUPNAME "Kowala"
!define APPNAME "kcoin"
!define DESCRIPTION "Official Go implementation of the Kowala protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since kcoin is installed global
