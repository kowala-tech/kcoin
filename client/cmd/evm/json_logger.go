...
func (l *JSONLogger) CaptureState(env *vm.EVM, pc uint64, op vm.OpCode, resourceUsage, price uint64, memory *vm.Memory, stack *vm.Stack, contract *vm.Contract, depth int, err error) error {
	log := vm.StructLog{
		Pc:                  pc,
		Op:                  op,
...
func (l *JSONLogger) CaptureFault(env *vm.EVM, pc uint64, op vm.OpCode, resourceUsage, price uint64, memory *vm.Memory, stack *vm.Stack, contract *vm.Contract, depth int, err error) error {
	return nil
}
