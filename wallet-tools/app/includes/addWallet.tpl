    ...
    <article class="col-md-4 col-sm-6">
      ...
      <section ng-show="walletType=='watchonlyaccount'">
        ...
        <p class="text-danger" translate="ADD_Warning_1">
          You can add any account to "watch" on the wallets tab without uploading a private key. This does ** not ** mean you have access to this wallet, nor can you transfer kCoin from it.
        </p>
