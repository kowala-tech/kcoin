...
/* Onboarding */
ONBOARD_welcome_title           :  '欢迎使用 Kowala Wallet Tools',
...
ONBOARD_welcome_content__4      :  '什么是 KWT? ',
ONBOARD_welcome_content__5      :  'Kowala Wallet Tools 是一款免费, 开源的钱包客户端.',
ONBOARD_welcome_content__6      :  '你可以通过KWT来与区块链网络进行直接交互, 同时完全保留对私钥和资金的完全控制权.',
ONBOARD_welcome_content__7      :  '**你** 并且 **只有你** 才能能对你的账户安全负责.',
ONBOARD_welcome_content__8      :  '如果你不幸访问钓鱼网站或者丢失了私钥, 我们没有任何途径可以恢复或者冻结你的账户.',
ONBOARD_bank_title              :  'Kowala Wallet Tools 不是银行',
...
ONBOARD_interface_title         :  'Kowala Wallet Tools 只是操作接口',
ONBOARD_interface_content__1    :  '当你在Kowala Wallet Tools创建账户的时候, 实际上只是生成了一对具备密码学意义的数字串: 你账户的私钥和公钥(地址).',
...
ONBOARD_bank_title__alt         :  'KWT 不是银行',
...
ONBOARD_blockchain_content__4   :  '区块链中的区块是由许多笔交易记录组成的, 这些交易从与跟KWT类似的操作接口发送出来, 比如MetaMask, Exodus, Mist, Geth, Parity等.',
ONBOARD_blockchain_content__5   :  '当你使用 Kowala Wallet Tools 查看余额, 或者使用 [etherscan.io](https://etherscan.io)查看交易详细信息时, 这些显示的信息都是直接来自区块链网络, 而不是来自KWT的独立系统.',
ONBOARD_blockchain_content__6   :  '再次申明: **Kowala Wallet Tools不是银行**.',
ONBOARD_interface_title__alt    :  'KWT 只是操作接口',
...
ONBOARD_blockchain_title__alt   :  '什么是区块链?',
ONBOARD_point_title__alt        :  '那我用KWT还有啥意义?',
ONBOARD_whymew_title            :  '如果Kowala Wallet Tools都不能做前面说的那些事, 那我为啥还要用它?',
...
ONBOARD_whymew_content__5       :  '如果你还是觉得用KWT太麻烦, 那你可以考虑用 [Coinbase](https://www.coinbase.com/) 或者 [Blockchain.info](https://blockchain.info/wallet/#/signup). 它们提供类似的使用用户名和密码来登录管理的账户系统.',
ONBOARD_whymew_content__6       :  '如果你担心 KWT 还不够安全, [那就赶紧买个硬件钱包吧](https://myetherwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! 它们能保证你密钥的安全.',
ONBOARD_why_title__alt          :  '但是为啥呢?',
ONBOARD_secure_title            :  '如何保护你的隐私和资金安全',
ONBOARD_secure_1_title          :  '如何防范钓鱼网站',
ONBOARD_secure_1_content__1     :  '钓鱼网站的常用伎俩是向你发送一条包含网站链接的信息, 并将这个链接伪装成很像Kowala Wallet Tools, kCoinDelta, Paypal或者银行的网站.当用户访问这些钓鱼网站并不慎填写自己的账户信息后, 黑客就能窃取这些信息进而窃取你的资金.',
ONBOARD_secure_1_content__2     :  '可以安装 [EAL](https://chrome.google.com/webstore/detail/etheraddresslookup/pdknmigbbbhmllnmgdfalmedcmcefdfn) 或者 [MetaMask](https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn) 或者 [Cryptonite by Metacert](https://chrome.google.com/webstore/detail/cryptonite-by-metacert/keghdcpemohlojlglbiegihkljkgnige) 或者 [Kowala Wallet Tools Chrome Extension](https://chrome.google.com/webstore/detail/myetherwallet-cx/nlbmnnijcnlegkjjpcfjclmcfggfefdm) 这几个可以防范钓鱼网站的插件.',
...
ONBOARD_point_title__alt_2      :  '那我用KWT还有啥意义?',
...
ONBOARD_final_content__3        :  '如何安装 KWT + MetaMask',
ONBOARD_final_content__4        :  '如何离线在本地使用 KWT',
...
NAV_MyWallets               : '我的钱包 ',
NAV_Offline                 : '离线发送 ',
NAV_SendkCoin               : '发送以太币 / 发送代币 ', //combined these tabs
...
sidebar_donation            : 'Kowala Wallet Tools是保护你的隐私和安全的免费、开源服务。 我们收到的捐赠越多，我们开发新特性、听取你的反馈的时间就越多。我们只是两个尝试改变世界的两个开发者。您能帮助我们吗？ ',
sidebar_donate              : '捐赠 ',
sidebar_thanks              : '感谢你！！！ ',
...
MYWAL_Content_3             : '如果你想将来在Kowala Wallet Tools插件中使用该钱包，你需要手动添加私钥/JSON文件和密码。 ',
