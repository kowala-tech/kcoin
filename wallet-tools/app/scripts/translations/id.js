...
X_HelpfulLinks_4                :  'Migrasi ke/dari Kowala Wallet Tools',
...
ENS_Helper_21                   :  'Mengumumkan Tanggal Peluncuran kembali Kowala Name Service!',
...
EOS_06                          :  'Buka halaman Send kCoins & Tokens',
...
/* Onboarding */
ONBOARD_welcome_title           :  'Selamat datang di Kowala Wallet Tools',
...
ONBOARD_welcome_content__4      :  'Apa itu KWT? ',
ONBOARD_welcome_content__5      :  'Kowala Wallet Tools adalah antarmuka sisi klien berbasis open source yang gratis.',
ONBOARD_welcome_content__6      :  'KWT memungkinkan Anda untuk berinteraksi langsung dengan blockchain sambil tetap memegang kendali penuh atas kunci &amp; dana Anda.',
...
ONBOARD_bank_title              :  'Kowala Wallet Tools bukan Bank',
...
ONBOARD_interface_title         :  'Kowala Wallet Tools adalah sebuah antarmuka',
ONBOARD_interface_content__1    :  'Saat membuat akun di Kowala Wallet Tools, Anda menghasilkan kumpulan nomor kriptografi: Kunci Privat dan kunci publik (alamat) Anda.',
...
ONBOARD_bank_title__alt         :  'KWT bukan sebuah Bank',
...
ONBOARD_blockchain_content__4   :  'Blok di blockchain berisi catatan dari semua transaksi individual yang dikirim dari Kowala Wallet Tools, MetaMask, Exodus, Mist, Geth, Parity, dan lain-lainnya..',
ONBOARD_blockchain_content__5   :  'Saat Anda melihat saldo di Kowala Wallet Tools atau melihat transaksi Anda di [etherscan.io](https://etherscan.io), Anda melihat data di blockchain, bukan di sistem privat Anda.',
ONBOARD_blockchain_content__6   :  'Sekali lagi: **kami bukan sebuah bank**.',
ONBOARD_interface_title__alt    :  'KWT adalah sebuah antarmuka',
...
ONBOARD_blockchain_title__alt   :  'Apa itu Blockchain?',
ONBOARD_point_title__alt        :  'Jadi apa gunanya KWT kalau begitu?',
ONBOARD_whymew_title            :  'Jika Kowala Wallet Tools tidak dapat melakukan semua hal tersebut, lalu apa gunanya?',
...
ONBOARD_whymew_content__6       :  'Jika Anda takut tapi ingin menggunakan KWT, [gunakan dompet hardware](https://myetherwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! Perangkat ini akan menjaga kunci Anda tetap aman.',
...
ONBOARD_secure_1_content__1     :  'Phisher biasanya mengirim Anda pesan dengan link ke situs web yang sekilas terlihat seperti Kowala Wallet Tools, kCoinDelta, Paypal, atau bank Anda, namun bukan situs web yang asli. Mereka mencuri informasi Anda dan kemudian mencuri uang Anda.',
ONBOARD_secure_1_content__2     :  'Pasang [EAL](https://chrome.google.com/webstore/detail/etheraddresslookup/pdknmigbbbhmllnmgdfalmedcmcefdfn) atau [MetaMask](https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn) atau [Cryptonite by Metacert](https://chrome.google.com/webstore/detail/cryptonite-by-metacert/keghdcpemohlojlglbiegihkljkgnige) atau [Kowala Wallet Tools Chrome Extension](https://chrome.google.com/webstore/detail/myetherwallet-cx/nlbmnnijcnlegkjjpcfjclmcfggfefdm) untuk memblokir situs web jahat.',
...
ONBOARD_final_content__3        :  'Cara Setup KWT + MetaMask',
ONBOARD_final_content__4        :  'Cara Menjalankan KWT Offline / Lokal',
...
tx_notFound_4               : 'Gunakan dropdown di kanan atas & pilih node ETH lainnya (e.g. `ETH (kCoinscan.io)` atau `ETH (Infura.io)` atau `ETH (Kowala Wallet Tools)`) dan check kembali.',
...
GEN_Help_12                 : 'Pakailah untuk membuka dompet Anda melalui Kowala Wallet Tools (atau Mist, Geth, Parity maupun perangkat lunak dompet lainnya.) ',
...
NAV_SendkCoin               : 'Kirim kCoin dan Token ',
...
/* General */
x_Access                    : 'Akses ',
x_AddessDesc                : 'Address Anda dikenal juga sebagai `Account #` atau `Public Key` Anda. Address inilah yang diberikan kepada pihak lain agar mereka bisa mengirim kCoin atau Token. Pilihlah icon alamat berwarna untuk memudahkan identifikasi. Pastikan Address ini sama persis dengan yang tertulis di Dompet Kertas Anda maupun saat dipakai untuk keperluan lainnya. ',
x_Address                   : 'Alamat Anda ',
x_Cancel                    : 'Batal ',
x_CSV                       : 'File CSV (tidak ter-enkripsi) ',
x_Download                  : 'Unduh ',
x_Json                      : 'File JSON (tidak ter-enkripsi) ',
x_JsonDesc                  : 'Ini adalah Kunci Privat Anda dalam format JSON yang tidak ter-enkripsi. Tidak diperlukan password dan siapapun yang memiliki JSON Anda dapat mengakses dompet dan kCoin Anda tanpa password. ',
...
/* Footer */
FOOTER_1                    : 'Client-side tool open source berbasis javascript untuk membuat Dompet dan transaksi Kowala. ',
FOOTER_1b                   : 'Oleh ',
...
ADD_Warning_1               : 'Akun untuk "dilihat" dapat ditambahkan tanpa menggunakan Kunci Privat. Namun berarti tidak ada akses ke dompet tersebut dan transfer kCoin tidak bisa dilakukan. ',
...
ADD_Ledger_2                : 'Buka Aplikasi Kowala (atau aplikasi kontrak) ',
...
ADD_Ledger_0a               : 'Buka kembali Kowala Wallet Tools melalui koneksi (SSL) yang aman ',
ADD_Ledger_0b               : 'Buka kembali Kowala Wallet Tools menggunakan [Chrome](https://www.google.com/chrome/browser/desktop/) atau [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Buka kembali Kowala Wallet Tools melalui koneksi (SSL) yang aman ',
ADD_DigitalBitbox_0b        : 'Buka kembali Kowala Wallet Tools menggunakan [Chrome](https://www.google.com/chrome/browser/desktop/) atau [Opera](https://www.opera.com/) ',
...
SENDModal_Content_4         : 'CATATAN: Jika terjadi Error, kemungkinan Anda harus menambah kCoin ke akun Anda untuk menutup biaya gas dan pengiriman. Gas dibayar dalam kCoin. ',
...
MYWAL_Content_3             : 'Jika Anda akan memakai dompet ini dengan Kowala Wallet Tools CX Anda ke depan, Kunci Privat/JSON dan password harus ditambahkan lagi secara manual. ',
...
NODE_Warning                : 'Node Anda harus berupa HTTPS untuk dapat terhubung melalui Kowala Wallet Tools. Anda dapat [mengunduh Kowala Wallet Tools repo & menjalankannya secara lokal](https://github.com/kvhnuke/etherwallet/releases/latest) untuk terhubung ke node apa saja. Atau, dapatkan SSL certificate gratis melalui [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Nama Node',
NODE_Port                   : 'Port Node',
...
HELP_Remind_Desc_1          : '** Kowala, Kowala Wallet Tools & Kowala Wallet Tools CX, dan beberapa library Javascript yang kami gunakan sedang dalam pengembangan yang aktif.** Meskipun kami telah benar-benar menguji & puluhan ribu dompet telah berhasil diciptakan oleh para pengguna di seluruh dunia, selalu ada kemungkinan bahwa sesuatu yang tidak terduga dapat terjadi yang menyebabkan ETH Anda hilang. Tolong jangan menginvestasikan lebih dari yang Anda mampu kehilangan, dan mohon berhati-hati. Jika ada sesuatu yang buruk terjadi, kami mohon maaf, tapi **kami tidak bertanggung jawab atas kCoin yang hilang**. ',
HELP_Remind_Desc_2          : 'Kowala Wallet Tools & Kowala Wallet Tools CX bukan "dompet web". Anda tidak membuat akun atau memberikan kCoin Anda untuk kami pegang. Semua data tidak pernah meninggalkan komputer/browser Anda. Kami mempermudah Anda untuk membuat, menyimpan, dan mengakses informasi Anda dan berinteraksi dengan blockchain. ',
...
HELP_0_Desc_1               : 'Kowala Wallet Tools memberi Anda kemampuan untuk membuat dompet baru sehingga Anda dapat menyimpan kCoin oleh diri Anda sendiri, bukan di bursa. Proses ini dilakukan sepenuhnya di komputer Anda, bukan di server kami. Oleh karena itu, saat Anda membuat dompet baru, **Anda bertanggung jawab untuk menyimpan cadangan/backup-nya dengan aman**. ',
...
HELP_0_Desc_5               : 'Transfer kCoin ke dompet baru ini. ',
...
HELP_2a_Desc_2              : 'Simpan alamatnya. Anda bisa menyimpannya untuk diri sendiri atau membaginya dengan orang lain. Dengan cara itu, orang lain bisa mentransfer kCoin ke Anda. ',
HELP_2a_Desc_3              : 'Simpan untuk diri sendiri semua versi Kunci Privat. Jangan berbagi dengan orang lain. Kunci Privat tersebut akan Anda diperlukan saat Anda ingin mengakses kCoin Anda untuk mengirimkannya! Ada 3 jenis Kunci Privat: ',
...
HELP_2b_Title               : '2b) Bagaimana cara penyimpanan yang aman / offline / cold storage menggunakan Kowala Wallet Tools? ',
...
HELP_3_Desc_1               : '**Sebelum Anda mengirim kCoin ke dompet baru Anda**, Anda harus memastikan Anda memiliki akses ke dompet baru tersebut. ',
HELP_3_Desc_2               : 'Buka halaman "Lihat Info Dompet". ',
HELP_3_Desc_3               : 'Buka laman Kowala Wallet Tools bagian "Lihat Info Dompet" . ',
...
HELP_4_Title                : '4) Bagaimana cara mengirim kCoin dari satu dompet ke dompet lainnya? ',
...
HELP_4_Desc_2               : 'Buka halaman "Kirim kCoin dan Token". ',
...
HELP_4CX_Title              : '4) Bagaimana cara mengirim kCoin menggunakan Kowala Wallet Tools CX? ',
HELP_4CX_Desc_1             : 'Pertama, Anda perlu menambahkan dompet. Setelah melakukannya, Anda memiliki 2 pilihan: menggunakan "QuickSend" dari ikon Chrome Extension atau menggunakan halaman "Kirim kCoin dan Tokens". ',
...
HELP_4CX_Desc_12            : 'Menggunakan halaman "Kirim kCoin dan Tokens" ',

HELP_5_Title                : '5) Bagaimana cara menjalankan Kowala Wallet Tools secara offline/lokal? ',
HELP_5_Desc_1               : 'Anda dapat menjalankan Kowala Wallet Tools secara lokal di komputer Anda, bukan dari server GitHub. Anda dapat membuat dompet yang benar-benar offline dan mengirim transaksi dari laman "Transaksi Offline". ',
HELP_5_Desc_7               : 'Kowala Wallet Tools sekarang berjalan sepenuhnya di komputer Anda. ',
HELP_5_Desc_8               : 'Jika Anda belum pernah melakukannya, Anda harus menyimpan folder dan seluruh isinya (bukan hanya `index.html`) agar bisa menjalankan websitenya. Jangan rubah atau pindahkan file apapun yang ada di dalam folder. Jika Anda akan menyimpan backup dari Kowala Wallet Tools repo, sebaiknya simpan versi ZIP-nya untuk menggaransi bahwa isi foldernya lengkap. ',
HELP_5_Desc_9               : 'Karena kami masih terus memperbarui Kowala Wallet Tools, sebaiknya Anda juga memperbarui versi repo yang Anda simpan secara berkala. ',
...
HELP_8_Desc_1               : 'Kowala Wallet Tools bukan dompet web. Anda tidak memiliki login dan tidak ada yang bisa disimpan ke server kami. Ini hanyalah sebuah antarmuka yang memungkinkan Anda berinteraksi dengan blockchain. ',
HELP_8_Desc_2               : 'Jika situs Kowala Wallet Tools tidak berfungsi, Anda harus memakai cara lain (misalnya memakai geth atau Kowala Wallet/Mist) sebagai alternatifnya. Tapi Anda tidak perlu "mengeluarkan" kCoin Anda dari Kowala Wallet Tools karena kCoin Anda tidak disimpan di Kowala Wallet Tools. kCoin Anda tetap tersimpan dalam dompet yang Anda buat di situs kami. ',
HELP_8_Desc_3               : 'Sekarang Anda dapat mengimpor Kunci Privat yang tidak dienkripsi dan file dalam format Geth/Mist (terenkripsi) langsung ke geth/ Kowala Wallet/Mist dengan sangat mudah. Lihat pertanyaan #12 di bawah ini. ',
HELP_8_Desc_4               : 'Lebih dari itu, kemungkinan kita menghentikan layanan Kowala Wallet Tools sangat kecil. Hampir tidak ada biaya dari penyelenggaraan layanan ini karena kami tidak menyimpan data apapun. Kalaupun sampai kami menghentikan layanan, semua file ini akan selalu akan tersedia untuk umum di [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Anda bisa mendownload file ZIP-nya disana dan menjalankannya secara lokal. ',

HELP_8CX_Title              : '8) Apa yang terjadi jika Kowala Wallet Tools CX tidak beredar lagi? ',
...
HELP_8CX_Desc_2             : 'terlepas dari semua itu, **sangat penting** bagi Anda untuk membuat backup/cadangan dari semua informasi dompet baru yang Anda buat dengan Kowala Wallet Tools CX. Dengan begitu, jika terjadi sesuatu pada Kowala Wallet Tools CX atau komputer Anda, Anda masih memiliki semua informasi yang diperlukan untuk mengakses kCoin Anda. Lihat #2a untuk cara membuat backup/cadangan dompet Anda. ',
HELP_8CX_Desc_3             : 'Jika karena suatu hal maupun lainnya Kowala Wallet Tools CX tidak lagi tersedia di Chrome Store, Anda tetap dapat menemukan file aslinya di Github dan menjalankannya secara manual. Lihat #5 di atas. ',

HELP_9_Title                : '9) Kenapa halaman "Kirim kCoin dan Tokens" seperti offline? ',
...
HELP_12_Title               : '12) Bagaimana cara mengimpor dompet yang dibuat dengan Kowala Wallet Tools ke dalam geth / Kowala Wallet / Mist? ',
HELP_12_Desc_1              : 'Memakai file Geth/Mist JSON yang dibuat dari Kowala Wallet Tools v2+.... ',
...
HELP_12_Desc_7              : 'Buka aplikasi Kowala Wallet. ',
...
HELP_12_Desc_20             : 'Anda akan diminta untuk membuat password baru. Ini adalah password yang akan Anda gunakan di geth/Kowala Wallet/Mist setiap kali Anda akan mengirim transaksi, mohon diingat dan jangan sampai lupa. ',
...
HELP_12_Desc_26             : 'Anda akan diminta untuk membuat password baru. Ini adalah password yang akan Anda gunakan di geth/Kowala Wallet/Mist setiap kali Anda akan mengirim transaksi, mohon diingat dan jangan sampai lupa. ',
...
HELP_21_Desc_2              : 'Jawaban panjang versi ELI5: Kowala dibuat berdasarkan [Public Key Cryptography](https://en.wikipedia.org/wiki/Public-key_cryptography), dan lebih spesifiknya [Elliptic curve cryptography](https://eprint.iacr.org/2013/734.pdf) yang sangat banyak digunakan, tidak hanya di Kowala. Sebagian besar server dilindungi melalui ECC. Bitcoin juga menggunakannya, begitu pula SSH dan TLS dan banyak lagi lainnya. Secara spesifik, Kowala memakai kunci 256-bit, yang lebih kuat dari 128-bit dan 192-bit, yang juga banyak penggunanya dan masih dianggap aman oleh para ahli. ',
...
HELP_SecCX_Title            : 'Keamanan - Kowala Wallet Tools CX ',
...
HELP_SecCX_Desc_6           : 'Jika kami mengenkripsi item ini, Anda harus memasukkan password setiap kali Anda ingin melihat saldo akun atau melihat nickname. Jiak Anda khawatir, kami sarankan Anda menggunakan Kowala Wallet Tools, bukan Chrome Extension ini. ',
