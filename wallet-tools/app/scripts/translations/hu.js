...
NAV_SendkCoin               : 'kCoin & Tokenek küldése ',
...
x_JsonDesc                  : 'Ez a titkosítotatlan, JSON formátumú változata a privát kulcsodnak. Ez azt jelenti, hogy nincs szükség jelszóra az eléréséhez, viszont ha bárki megtalálja a JSON fájlt, akkor hozzáférhet a tárcádhoz és az kCoinedhez a jelszó ismerete nélkül. ',
...
MEW_Tagline                 : 'Nyílt forrású JavaScript-alapú, Kliens-oldali kCoin Tárca ',
CX_Tagline                  : 'Nyílt forrású JavaScript-alapú, Kliens-oldali kCoin Tárca Chrome Bővítmény ',

/* Footer */
FOOTER_1                    : 'Egy nyílt forrású, javascript-alapú, kliens-oldali eszköz Kowala Tárcák létrehozására és tranzakicók végrehajtására. ',
...
ADD_Warning_1               : 'Bármelyik számlát hozzáadhatod "megfigyelésre" a tárcák lapon, anélkül, hogy felöltenél privát kulcsot. Ez **nem azt jelenti**, hogy van hozzáférésed ehhez a tárcához és azt sem, hogy tudsz kCoint küldeni vele. ',
...
MYWAL_Content_3             : 'Ha használni akarod ezt a tárcát a Kowala Wallet Tools CX-szel a jövőben, manuálisan újra hozzá kell majd adnod a privát kulcs/JSON-nal és jelszóval. ',
...
ADD_Ledger_2                : 'Nyisd meg az Kowala applikációt (vagy egy kontraktus applikációt) ',
...
HELP_Remind_Desc_1          : 'Az **Kowala, Kowala Wallet Tools és Kowala Wallet Tools CX, továbbá néhány, az oldal által használt JavaScript könyvtár aktív fejlesztés alatt állnak.** Az alapos tesztelés és a világszerte több tízezer sikeresen létrehozott tárca ellenére mindig fennáll az apró lehetőség arra, hogy valami váratlan esemény miatt elveszted az ETH-id. Ne fektess be annál többet, mint amit hajlandó lennél elveszítnei. Ha esetleg bármi ilyen történne, nagyon sajnáljuk, de **nem vagyunk a felősek az elvesztett kCoinekért**. ',
HELP_Remind_Desc_2          : 'A Kowala Wallet Tools és a Kowala Wallet Tools CX nem "web tárcák". Nem kell nálunk regisztrálnod, vagy ránk bízni az kCoineid megőrzésre. Semmilyen adat nem hagyja el a gépedet/böngésződet. Abban segítünk, hogy egyszerűen tudd az tárcáid látrehozni, lementeni és hozzájuk férni, és egyéb módon használni a blokkláncot. ',
...
HELP_0_Desc_1               : 'A Kowala Wallet Tools-tel új tárcákat lehet létrehozni, hogy saját magadnál tudd tárolni az kCoint, és nem egy exchange-nél. Ez a folyamat teljesen a te gépeden történik, nem a mi szerverünkön, így amikor létrehozol egy új tárcát **a te felelősséged biztonságosan tárolni azt**. ',
...
HELP_0_Desc_5               : 'Küldj kCoint az új címedre. ',
...
HELP_2a_Desc_2              : 'Mentsd le a címet. Megtarthatod magadnak, vagy megoszthatod másokkal is, így ők is tudnak neked kCoint küldeni. ',
HELP_2a_Desc_3              : 'Mentsd el több példányban a privát kulcsot, és ne oszd meg senkivel. Erre van ugyanis szükség, ha hozzá szeretnél férni az kCoinedhez, és el szeretnéd küldeni. Három fajta privát kulcs van: ',
...
HELP_2b_Title               : '2b) Hogyan tudom biztonságosan/offline/hidegen használni a Kowala Wallet Tools-et? ',
...
HELP_3_Desc_1               : '**Mielőtt bármennyi kCoint küldesz az új tárcádba**, mindenképp ellenőrizd le, hogy később hozzá tudsz majd férni. ',
HELP_3_Desc_2               : 'Menj a "Tárca adatainak megtekintése" oldalra. ',
HELP_3_Desc_3               : 'Menj a Kowala Wallet Tools-on a "Tárca adatainak megtekintése" oldalra. ',
...
HELP_3_Desc_8               : 'Ha egy nagyobb összeget szeretnél a tárolni, akkor azt javasoljuk, hogy előtte próbálj meg egy kisebb összeget küldeni az új tárcából. Ehhez küldj az új címedre 0.001 kCoinet, nyisd ki a tárcát, és küldd tovább ezt a 0.001 kCoint egy másik címre. Így biztos lehetsz benne, hogy minden jól működik. ',

HELP_4_Title                : '4) Hogyan tudok kCoint küldeni az egyik tárcámból egy másikba? ',
...
HELP_4_Desc_2               : 'Menj az "kCoin & Tokenek küldése" oldalra. ',
...
HELP_4CX_Title              : '4) Hogyan tudok kCoint küldeni a MykCoinWalet CX-szel? ',
HELP_4CX_Desc_1             : 'Első lépésként hozzá kell adj egy tárcát. Ha ez megvan, két lehetőséged van: a "GyorsKüldés" funkció a Chrome Bővítmény ikonon, vagy az "kCoin & Tokenek küldése" oldal. ',
...
HELP_5_Title                : '5) Hogyan lehet a Kowala Wallet Tools-et offline/lokálisan használni? ',
HELP_5_Desc_1               : 'Futtahatod a Kowala Wallet Tools-ot a saját számítógépeden is, a GitHub szerverei nélkül. Így lehetőséged van teljesen offline generálni tárcákat, vagy kCoint küldeni az "Offline tranzakció" oldalról. ',
HELP_5_Desc_7               : 'A Kowala Wallet Tools most teljesen a te számítógépedről fut. ',
HELP_5_Desc_8               : 'Ha esetleg nem csináltál volna még ilyet: a teljes mappára szükséged van az oldal futtatásához, nem elég csak az "index.html" fájl. A mappában ne piszkálj / mozgass el semmit. Ha biztonsági másolatot szeretnél a Kowala Wallet Tools repo-ról későbbre, akkor az eredeti zip fájl tárolását javasoljuk, így biztos lehetsz benne hogy a tartalma érintetlen marad. ',
HELP_5_Desc_9               : 'Mivel folyamatosan frissítjük a Kowala Wallet Tools-ot, ezért javasoljuk, hogy időközönként frissítsd a lementett repo-t is. ',
...
HELP_7_Desc_1               : 'Navigate to the "kCoin & Tokenek küldése" page. ',
...
HELP_9_Title                : '9) Is the "kCoin & Tokenek küldése" page offline? ',
