...
tx_notFound_4               : 'Bitte benutzen Sie das DropDown Menü oben-rechts & wählen Sie eine andere Node aus (z.B. `ETH (kCoinscan.io)` oder `ETH (Infura.io)` oder `ETH (Kowala Wallet Tools)`) und prüfen es erneut.',
...
GEN_Help_12                 : 'Nutze es um dein Wallet bei Kowala Wallet Tools (oder Mist, Geth, Parity und andere Wallet Clients.) zu öffnen ',
...
NAV_SendkCoin               : 'Sende kCoin und Tokens ',
...
/* General */
x_Access                    : 'Zugriff ',
x_AddessDesc                : 'Dies ist Ihre "Kontonummer" oder Ihr "Öffentlicher Schlüssel". Sie benötigen diese Adresse, wenn Ihnen jemand kCoin oder Tokens senden möchte. Das Icon ist eine einfache Möglichkeit, die Adresse zu überprüfen ',
x_Address                   : 'Ihre Adresse ',
x_Cancel                    : 'Abbrechen ',
x_CSV                       : 'CSV-Datei (unverschlüsselt) ',
x_Download                  : 'Herunterladen ',
x_Json                      : 'JSON-Datei (unverschlüsselt) ',
x_JsonDesc                  : 'Dies ist die unverschlüsselte Version deines privaten Schlüssels im JSON-Format. Du benötigst daher kein Passwort, aber jeder, der über diese JSON-Datei verfügt, hat ohne Passwort Zugang zu deinem Wallet und dem darin enthaltenen kCoin. ',
...
/* Footer */
FOOTER_1                    : 'Ein quelloffenes, browserseitiges Werkzeug zur Erzeugung von Kowala-Wallets und Versenden von Transaktionen. ',
...
ADD_Warning_1               : 'Du kannst unter dem "Wallet-Tab" eine Kontoadresse "beobachten", ohne den privaten Schlüssel hochzuladen. Du hast damit **keinen** Zugang zu diesem Wallet und kannst auch keinen kCoin daraus versenden. ',
...
SENDModal_Content_4         : 'HINWEIS: Wenn Sie eine Fehlermeldung erhalten, müssen Sie vermutlich Ihren kCoin-Saldo erhöhen, um die Gas-Kosten des Token-Versands zu bezahlen. Gas wird in kCoin bezahlt. ',
...
MYWAL_Content_3             : 'Wenn Sie dieses Wallet in Zukunft mit Kowala Wallet Tools CX verwenden wollen, müssen Sie es mittels des privaten Schlüssels/JSON Datei und Ihrem Passwort manuell wieder hinzufügen. ',
...
ADD_Ledger_2                : 'Öffne das Kowala Programm (oder ein Vertragsprogramm) ', //Statt Programm -> Applikation?
...
HELP_0_Desc_1               : 'Kowala Wallet Tools bietet dir die Möglichkeit neue Wallets zu generieren, damit du deinen kCoin selbst speichern kannst, und keine Exchange nutzen musst. Dieser Prozess findet ausschließlich auf deinem Computer statt. Daher bist auch **du dafür Verantwortlich, Back-ups zu erstellen** wenn du ein Wallet verwenden möchtest. ',
...
HELP_0_Desc_5               : 'Überweise kCoin auf das neue Wallet. ',
...
HELP_2a_Desc_2              : 'Speichere die Adresse. Du kannst sie für dich behalten oder mit anderen teilen. Auf diese Adresse können andere kCoin an dich senden. ',
HELP_2a_Desc_3              : 'Speiche verschiedene Versionen deines privaten Schlüssels. Teile ihn nicht mit jemand anderem. Dein privater Schlüssel ist notwendig, wenn du auf deinen kCoin zugreifen willst, um eine Überweisung zu tätigen! Es gibt 3 Arten des privaten Schlüssels ',
...
HELP_4_Title                : '4) Wie kann ich kCoin von einer Wallet zur anderen senden? ',
...
HELP_4_Desc_2               : 'Navigate to the "Sende kCoin und Tokens" page. ',
...
HELP_4CX_Title              : '4) Wie kann ich kCoin über Kowala Wallet Tools CX senden? ',
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Sende kCoin und Tokens" page. ',
...
HELP_4CX_Desc_12            : 'Using "Sende kCoin und Tokens" Page ',

HELP_5_Title                : '5) Wie kann ich Kowala Wallet Tools offline/lokal starten? ',
...
HELP_7_Desc_1               : 'Navigate to the "Sende kCoin und Tokens" page. ',
...
HELP_9_Title                : '9) Is the "Sende kCoin und Tokens" page offline? ',
