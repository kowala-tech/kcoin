...
tx_notFound_4               : 'Utilitza el menú desplegable a la part superior dreta i selecciona un node ETH diferent (p. Ex. `ETH (kCoinscan.io)` o `ETH (Infura.io)` o `ETH (Kowala Wallet Tools)`)  i torna-ho a comprovar.',
...
GEN_Help_12                 : 'Utilitza\'l per desbloquejar la teva cartera amb Kowala Wallet Tools (o Mist, Geth, Parity i altres clients de carteres.) ',
...
NAV_SendkCoin               : 'Envia kCoin & Tokens ',
...
/* General */
x_Access                    : 'Accedir ',
x_AddessDesc                : 'La teva adreça també pot ser anomenada `# de compte` o `Clau Pública`. És el que comparteixes amb la gent perquè puguin enviar-te kCoin o Tokens. Cerqueu la icona d\'adreça de colors. Assegura\'t que coincideixi amb la vostra cartera de paper i quan introduïu la vostra adreça en algun lloc.',
x_Address                   : 'La teva adreça ',
x_Cancel                    : 'Cancel·lar ',
x_CSV                       : 'Fitxer CSV (no xifrat) ',
x_Download                  : 'Descarregar ',
x_Json                      : 'Fitxer JSON(no xifrat) ',
x_JsonDesc                  : 'Aquesta és la teva clau privada no xifrada, en format JSON. Això significa que no necessites la contrasenya, però qualsevol que trobi el JSON pot accedir a la teva cartera i kCoin sense la contrasenya. ',
...
/* Header */
CX_Tagline                  : 'Cartera d\'kCoin de codi obert programada amb JavaScript executada en el client com a extensió de Chrome ',
...
MEW_Tagline                 : 'Cartera d\'kCoin de codi obert programada amb JavaScript ',
...
/* Footer */
FOOTER_1                    : 'Eina gratuïta, de codi obert que s\'executa en el client per generar carteres d\'Kowala i més. Interactua fàcilment amb la blockchain d\'Kowala de manera fàcil i segura. Comprova l\'URL (.com) abans de desbloquejar la teva cartera.',
FOOTER_1b                   : 'Creat per ',
...
ADD_Ledger_2                : 'Obre l\'aplicació d\'Kowala (o una aplicació de contracte) ',
...
ADD_Ledger_0a               : 'Has d\'accedir a Kowala Wallet Tools utilitzant una connexió segura (SSL / HTTPS). ',
ADD_Ledger_0b               : 'Torna a obrir Kowala Wallet Tools utilitzant [Chrome](https://www.google.com/chrome/browser/desktop/) o [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Torna a obrir Kowala Wallet Tools utilitzant una connexió segura (SSL) ',
ADD_DigitalBitbox_0b        : 'Torna a obrir Kowala Wallet Tools utilitzant [Chrome](https://www.google.com/chrome/browser/desktop/) o [Opera](https://www.opera.com/) ',
...
ADD_Warning_1               : 'Pots afegir qualsevol compte per "supervisar" a la pestanya de carteres sense pujar una clau privada. Això ** no ** vol dir que tinguis accés a aquesta cartera ni que puguis transferir-ne l\'kCoin d\'aquesta. ',
...
MYWAL_Content_3             : 'Si vols utilitzar aquesta cartera amb Kowala Wallet Tools CX en el futur, hauràs de tornar a afegir-la manualment utilitzant la clau privada/JSON i contrasenya. ',
...
NODE_Warning                : 'El teu node ha de ser HTTPS per tal de poder-t\'hi connectar utilitzant Kowala Wallet Tools. Pots [descarregar-te el repo de Kowala Wallet Tools i executar-lo localment](https://github.com/kvhnuke/etherwallet/releases/latest) per connectar-te a qualsevol node. O, obtén un certificat SSSL gratuït amb [LetsEncrypt](https://letsencrypt.org/)',
