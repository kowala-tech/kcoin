...
GEN_Help_12                 : 'Använd filen för att låsa upp din plånbok via t.ex Kowala Wallet Tools, Mist, Geth, Parity eller andra klienter.',
...
NAV_SendkCoin               : 'Skicka kCoin och Tokens ',
...
x_JsonDesc                  : 'Det här är din okrypterade privata nyckel i JSON format. Det här betyder att du inte behöver ditt lösenord men vem som helst som hittar din JSON kan få tillgång till din plånbok och kCoin utan ditt lösenord. ',
...
sidebar_donation            : 'Kowala Wallet Tools är en gratis service, med öppen källkod inriktade på din integritet och säkerhet. Ju fler donationer vi får, desto mer tid lägger vi på att skapa nya funktioner, lyssna på feedback, och ge dig vad du vill. Vi är bara två personer som försöker förändra världen. Hjälp oss? ',
...
MYWAL_Content_3             : 'Om du vill använda plånboken med Kowala Wallet Tools CX i framtiden, måste du manuellt lägga till den med hjälp av den privata nyckeln / JSON filen och lösenordet. ',
