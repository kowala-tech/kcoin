...
tx_notFound_4               : 'Παρακαλούμε χρησιμοποιήστε το αναπτυσσόμενο μενού πάνω δεξιά και επιλέξτε κάποιον διαφορετικό κόμβο ETH (π.χ. `ETH (kCoinscan.io)` ή `ETH (Infura.io)` ή `ETH (Kowala Wallet Tools)`) και ελέγξτε ξανά.',
...
GEN_Help_12                 : 'Χρησιμοποιήστε το για να ξεκλειδώσετε το πορτοφόλι σας μέσω του Kowala Wallet Tools (ή μέσω του Mist, του Geth, του Parity και άλλων προγραμμάτων-πελατών πορτοφολιού.) ',
...
NAV_SendkCoin               : 'Αποστολή αιθέρα και μαρκών ',
...
/* Footer */
FOOTER_1                    : 'Ένα εργαλείο ανοιχτού κώδικα, javascript, από πλευράς πελάτη για τη δημιουργία πορτοφολιών Kowala & αποστολή συναλλαγών. ',
...
MYWAL_Content_3             : 'Αν θέλετε να χρησιμοποιήσετε το πορτοφόλι αυτό με το Kowala Wallet ToolsCX στο μέλλον, θα χρειαστεί να το ξαναπροσθέσετε χειροκίνητα χρησιμοποιώντας το ιδιωτικό κλειδί/JSON και το συνθηματικό. ',
...
ADD_Ledger_2                : 'Ανοίξτε την εφαρμογή Kowala (ή μια εφαρμογή συμβολαίου) ',
...
ADD_Ledger_0a               : 'Ξανα-ανοίξτε το Kowala Wallet Tools σε ασφαλή (SSL) σύνδεση ',
ADD_Ledger_0b               : 'Ξανα-ανοίξτε το Kowala Wallet Tools χρησιμοποιώντας το [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/) ',
...
HELP_2b_Title               : '2β) Πώς μπορώ να έχω ασφάλεια / συναλλαγές εκτός σύνδεσης / ψυχρή αποθήκευση με το Kowala Wallet Tools? ',
...
HELP_3_Desc_3               : 'Μεταβείτε στη σελίδα «Προβολή πληροφοριών ποστοφολιού» του Kowala Wallet Tools. ',
...
HELP_8_Desc_1               : 'Το Kowala Wallet Tools δεν είναι πορτοφόλι ιστού. Δεν γίνεται σύνδεση χρήστη και τίποτα δεν αποθηκεύεται στους διακομιστές μας. Είναι απλά μια διεπαφή που σας επιτρέπει να αλληλεπιδράσετε με το blockchain. ',
HELP_8_Desc_2               : 'Αν το Kowala Wallet Tools πέσει, μπορείτε να χρησιμοποιήσετε κάποιον άλλον τρόπο (όπως το geth ή το Kowala Wallet / Mist) για να κάνετε ό,τι κάνουμε. Αλλά δεν θα χρειαστεί να «βγάλετε» τον Αιθέρα σας από το Kowala Wallet Tools επειδή δεν βρίσκεται μέσα στο Kowala Wallet Tools. Βρίσκεται στο όποιο πορτοφόλι δημιουργήσατε μέσω του ιστοτόπου μας. ',
HELP_8_Desc_3               : 'Μπορείτε να εισαγάγετε πολύ εύκολα το μη κρυπτογραφημένο σας ιδιωτικό κλειδί και τα αρχεία σε φορμά Geth / Mist (κρυπτογραφημένα) απευθείας στο geth / Kowala Wallet / Mist. Δείτε την ερώτηση Νο 12 παρακάτω. ',
HELP_8_Desc_4               : 'Επιπρόσθετα, η πιθανότητα να πέσει το Kowala Wallet Tools είναι ελάχιστη έως ανύπαρκτη. Δεν μας κοστίζει σχεδόν τίποτα να το διατηρούμε, δεδομένου ότι δεν αποθηκεύουμε καμία πληροφορία. Εάν πάψει να λειτουργεί το όνομα χώρου, το Kowala Wallet Tools εξακολουθεί να είναι και πάντα θα είναι διαθέσιμο δημοσίως στη διεύθυνση [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Μπορείτε να κατεβάσετε το ZIP και να το εκτελέσετε τοπικά. ',
...
HELP_14_Title               : '14) Ορισμένοι ιστότοποι τυχαιοποιούν την παραγωγή του ιδιωτικού κλειδιού μέσω κινήσεων του ποντικιού. Το Kowala Wallet Tools δεν το κάνει αυτό. Είναι ασφαλής η παραγωγή τυχαίων αριθμών για το Kowala Wallet Tools; ',
HELP_14_Desc_1              : 'Ενώ αυτό το πράγμα με τις κινήσεις του ποντικιού είναι έξυπνο και καταλαβαίνουμε γιατί αρέσει στους περισσότερους ανθρώπους, η πραγματικότητα όμως είναι ότι το window.crypto εξασφαλίζει περισσότερη εντροπία από τις κινήσεις του ποντικιού σας. Δεν είναι ότι οι κινήσεις του ποντικιού δεν είναι ασφαλείς, είναι ότι εμείς (και οι τόνοι πειραμάτων κρυπτογράφησης) πιστεύουμε στο window.crypto. Επιπλέον, το Kowala Wallet Tools μπορεί να χρησιμοποιηθεί σε συσκευές αφής. Εδώ είναι μια [συζήτηση μεταξύ ενός θυμωμένου redditor και του Vitalik Buterin σχετικά με τις κινήσεις του ποντικιού έναντι του window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) και εδώ είναι οι [προδιαγραφές w3 του window.crypto](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
