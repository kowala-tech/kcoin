...
ENS_Helper_21                   :  '¡Anunciando la fecha de relanzamiento del servicio de nombres de Kowala!',
...
/* Onboarding */
ONBOARD_welcome_title           :  'Bienvenido a Kowala Wallet Tools',
...
ONBOARD_welcome_content__4      :  '¿Qué es KWT? ',
ONBOARD_welcome_content__5      :  'Kowala Wallet Tools es una interfaz gratuita, de código abierto, del lado del cliente.',
...
ONBOARD_bank_title              :  'Kowala Wallet Tools no es un banco',
...
ONBOARD_interface_title         :  'Kowala Wallet Tools es una Interfaz',
ONBOARD_interface_content__1    :  'Cuando crea una cuenta en Kowala Wallet Tools está generando un conjunto criptográfico de números: su clave privada y su clave pública (dirección).',
...
ONBOARD_bank_title__alt         :  'KWT no es un banco',
...
ONBOARD_blockchain_content__4   :  'Los bloques en el blockchain se componen de todas las transacciones individuales enviadas desde Kowala Wallet Tools, MetaMask, Exodus, Mist, Geth, Parity y en cualquier otro lugar.',
ONBOARD_blockchain_content__5   :  'Cuando vea su saldo en Kowala Wallet Tools o vea sus transacciones en [etherscan.io] (https://etherscan.io), verá datos en la cadena de bloques, no en nuestros sistemas personales.',
ONBOARD_blockchain_content__6   :  'De nuevo: **no somos un banco**.',
ONBOARD_interface_title__alt    :  'KWT es una Interfaz',
...
ONBOARD_blockchain_title__alt   :  '¿Qué es una Blockchain?',
ONBOARD_point_title__alt        :  '¿De qué sirve KWT entonces?',
ONBOARD_whymew_title            :  'Si Kowala Wallet Tools no puede hacer esas cosas, ¿para qyé sirve?',
...
ONBOARD_whymew_content__6       :  'Si tiene miedo pero quiere usar KWT, [consiga una billetera de hardware](https://myetherwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! These keep your keys secure.',
...
ONBOARD_secure_1_content__1     :  'Phishers le envía un mensaje con un enlace a un sitio web que se parece a Kowala Wallet Tools, kCoinDelta, Paypal o a su banco, pero no es el sitio web real. Le roban su información y luego le roban su dinero.',
...
ONBOARD_final_content__3        :  'Cómo configurar KWT + MetaMask',
ONBOARD_final_content__4        :  'Cómo ejecutar KWT Offline / Locally',
...
tx_notFound_4               : 'Por favor usa el desplegable en la parte superior derecha y selecciona un nodo ETH diferente (ej. `ETH (kCoinscan.io)` o `ETH (Infura.io)` o `ETH (Kowala Wallet Tools)`) y comprueba de nuevo.',
...
GEN_Help_12                 : 'Úselo para desbloquear su billetera a través de Kowala Wallet Tools (o Mist, Geth, Parity y otros clientes de billetera). ',
...
NAV_SendkCoin               : 'Enviar ether y tokens ',
...
MEW_Tagline                 : 'Cartera kCoin JavaScript de código abierto ejecutado en el cliente ',
CX_Tagline                  : 'Cartera kCoin JavaScript de código abierto ejecutado en el cliente extensión Chrome ',

/* Footer */
FOOTER_1                    : 'Una herramienta de código abierto JavaScript que se ejecuta en el lado del cliente, para generar carteras y enviar transacciones Kowala. ',
...
MYWAL_Content_3             : 'Si en el futuro quieres utilizar esta cartera con Kowala Wallet Tools CX, tendrás que volver a añadirla manualmente utilizando Clave Privada/JSON y contraseña. ',
...
NODE_Warning                : 'Tu nodo debe ser HTTPS para poder conectar a él desde Kowala Wallet Tools. Para conectarte a cualquier nodo, puedes [descargar el repositorio de Kowala Wallet Tools y ejecutarlo localmente](https://github.com/kvhnuke/etherwallet/releases/latest). También puedes conseguir un certificado SSL gratuito a través de [Let\'s Encrypt](https://letsencrypt.org/)',
...
ADD_Ledger_2                : 'Inicia la aplicacin Kowala (o una aplicación de contrato) ',
...
ADD_Ledger_0a               : 'Volver a abrir Kowala Wallet Tools en una conexión segura (SSL) ',
ADD_Ledger_0b               : 'Volver a abrir Kowala Wallet Tools usando [Chrome](https://www.google.com/chrome/browser/desktop/) u [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Volver a abrir Kowala Wallet Tools en una conexión segura (SSL) ',
ADD_DigitalBitbox_0b        : 'Volver a abrir Kowala Wallet Tools usando [Chrome](https://www.google.com/chrome/browser/desktop/) u [Opera](https://www.opera.com/) ',
...
HELP_0_Desc_1               : 'Kowala Wallet Tools te permite generar nuevas carteras para poder almacenar tu kCoin por tu cuenta en lugar de en una casa de cambio. Este proceso tiene lugar por completo en tu equipo, no en nuestros servidores. Por lo tanto, cuando generes una nueva cartera, **eres responsable de hacer una copia de seguridad**. ',
...
HELP_0_Desc_5               : 'Transferir kCoin a la nueva cartera. ',
...
HELP_2b_Title               : '2b) ¿Cómo almaceno con seguridad/sin conexión/en frío con Kowala Wallet Tools? ',
...
HELP_3_Desc_3               : 'Ve a la página "Ver Información de las Carteras" de Kowala Wallet Tools. ',
...
HELP_4_Desc_2               : 'Ve a la página "Enviar kCoin y Tokens". ',
...
HELP_4CX_Title              : '4) ¿Cómo envío ether utilizando Kowala Wallet Tools CX? ',
HELP_4CX_Desc_1             : 'Antes de nada, necesitas añadir una cartera. Una vez hecho, tienes dos opciones: la función "Enviar" del icono de la extensión de Chrome o la página "Enviar kCoin y Tokens". ',
...
HELP_4CX_Desc_12            : 'Utilizando la página "Enviar kCoin y Tokens" ',

HELP_5_Title                : '5) ¿Cómo ejecuto Kowala Wallet Tools sin conexión/localmente? ',
HELP_5_Desc_1               : 'Puedes ejecutar Kowala Wallet Tools en tu equipo en lugar de desde los servidores de GitHub. Puedes generar una cartera totalmente sin conexión y enviar transacciones desde la página "Transacción sin conexión". ',
HELP_5_Desc_7               : 'Kowala Wallet Tools is now running entirely on your computer. ',
HELP_5_Desc_8               : 'Por si no tienes costumbre, es necesario guardar la carpeta completa para ejecutar la página web, no solamente `index.html`. No modifiques ni muevas nada dentro de la carpeta. Si estás guardando una copia del repositorio Kowala Wallet Tools para el futuro, recomendamos guardar únicamente el fichero ZIP para poder estar seguro de que el contenido permanezca intacto. ',
HELP_5_Desc_9               : 'Debido a que estamos constantemente actualizando Kowala Wallet Tools, recomendamos que actualices periódicamente tu versión guardada del repositorio. ',
...
HELP_8_Desc_1               : 'Kowala Wallet Tools no es una cartera web. No tienes un login y nunca se graba nada en nuestros servidores. You don\'t have a login and nothing ever gets saved to our servers. Simplemente es una interfaz que te permite interactuar con la cadena de bloques. ',
HELP_8_Desc_2               : 'Si Kowala Wallet Tools desapareciera, tendrías que encontrar otra manera de poder hacer lo que haces con nosotros (como por ejemplo obtener geth o Kowala Wallet / Mist). Pero no necesitarías retirar tus ether de Kowala Wallet Tools porque no están en Kowala Wallet Tools. Están en la cartera que hayas generado a través de nuestro sitio. ',
HELP_8_Desc_3               : 'Puedes importar tu clave privada sin cifrar y tus archivos en formato Geth/Mist (cifrados) directamente en geth / Kowala Wallet / Mist con mucha facilidad actualmente. Ver más abajo la pregunta #12. ',
HELP_8_Desc_4               : 'Además, la probabilidad de que cerremos Kowala Wallet Tools es casi nula. No nos cuesta prácticamente nada mantenerlo ya que no almacenamos ninguna información. Si borramos el dominio, continúa estando disponible y siempre lo estará en [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Puedes descargar desde ahí el archivo ZIP y ejecutarlo localmente. ',

HELP_8CX_Title              : '8) ¿Qué ocurre si Kowala Wallet Tools CX desaparece? ',
...
HELP_8CX_Desc_2             : 'Dicho esto, es **muy importante** que respaldes toda tu información para todas las nuevas carteras generadas con Kowala Wallet Tools CX. De este modo, si algo le ocurre a Kowala Wallet Tools CX o a tu equipo, seguirás teniendo toda la información necesaria para poder acceder a tus ether. Ver la pregunta #2a sobre cómo respaldar tus carteras. ',
HELP_8CX_Desc_3             : 'Si por algún motivo Kowala Wallet Tools CX desaparece de Chrome Store, puedes encontrar el código fuente en Github y cargarlo manualmente. Ver #5 más arriba. ',
...
HELP_10_Desc_11             : 'On your online computer, paste the signed transaction into the text field in step #3 and click "Enviar kCoin y Tokens". This will broadcast your transaction. ',
...
HELP_SecCX_Title            : 'Seguridad - Kowala Wallet Tools CX ',
...
HELP_SecCX_Desc_6           : 'Si cifráramos estos ítems, sería necesario que introduzcas una contraseña cada vez que quisieras comprobar el saldo de tu cuenta o vizualizar los alias. Si esto te preocupa, te recomendamos que utilices Kowala Wallet Tools en lugar de esta extensión de Chrome. ',
