...
NAV_SendkCoin               : 'Перевести эфир (ether) и токены ',
...
MEW_Tagline                 : 'Kowala кошелёк на javascript с открытым исходным кодом ',
CX_Tagline                  : 'Kowala кошелёк на javascript с открытым исходным кодом в виде расширения для браузера Chrome ',

/* Footer */
FOOTER_1                    : 'Написанный на javascript инструмент с открытым исходным кодом для создания Kowala кошельков и выполнения транзакций. ',
FOOTER_1b                   : 'Авторы: ',
...
MYWAL_Content_3             : 'Если Вы планируете в будущем использовать этот кошелёк в Kowala Wallet Tools CX, Вам надо будет вручную заново добавить его, указав закрытый ключ или файл JSON и пароль. ',
...
NODE_Warning                : 'Ваш узел должен использовать протокол HTTPS, чтобы Kowala Wallet Tools мог с ним работать. Вы можете [скачать репозиторий Kowala Wallet Tools & и запустить его локально](https://github.com/kvhnuke/etherwallet/releases/latest) чтобы иметь возможность работать с любыми узлами, или получите бесплатный SSL сертификат на [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Имя узла',
NODE_Port                   : 'Порт узла',
...
ADD_Ledger_2                : 'Запустите приложение Kowala (или приложение контракта) ',
...
ADD_Ledger_0a               : 'Перезапустите Kowala Wallet Tools через безопасное (SSL) соединение ',
ADD_Ledger_0b               : 'Перезапустите Kowala Wallet Tools с браузере [Chrome](https://www.google.com/chrome/browser/desktop/) или [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Перезапустите Kowala Wallet Tools через безопасное (SSL) соединение ',
ADD_DigitalBitbox_0b        : 'Перезапустите Kowala Wallet Tools с браузере [Chrome](https://www.google.com/chrome/browser/desktop/) или [Opera](https://www.opera.com/) ',
