...
NAV_SendkCoin               : 'kCoin ve Tokens gönder ',
...
MEW_Tagline                 : 'Acik kaynak JavaScript Client-Side kCoin cüzdani ',
CX_Tagline                  : 'Acik kaynak JavaScript Client-Side kCoin cüzdani Chrome Extension ',

/* Footer */
FOOTER_1                    : 'Acik kaynak, javascript Client-Side kCoinerum cüzdani ve kCoin islemleri ',
...
sidebar_donation            : 'Kowala Wallet Tools gizlilik ve güvenlike adanmış ücretsiz ve açık kaynak kodlu bir hizmettir. Ne kadar cok bagis edilirse o kadar cok yeni özellik programlamaya, görüşlerinizi işlemeye yatitim yapabiliriz. Biz sadece dünyayı değiştirmek isteyen iki kişiyiz. Bize yardım edermisin? ',
...
ADD_Warning_1               : 'Özel anahtar yazmadan cüzdan sekmesinde "izlemek" için herhangi bir hesap ekleyebilirsin. Bu demek ** degilki ** cüzdani acabilirsin, veya ondan kCoin aktarabilirsin. ',
...
HELP_4_Desc_2               : 'Navigate to the "kCoin ve Tokens göndermek" page. ',
...
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Send kCoin" page. ',
...
HELP_4CX_Desc_12            : 'Using "Send kCoin" Page ',

HELP_5_Title                : '5) How do I run Kowala Wallet Tools offline/locally? ',
HELP_5_Desc_1               : 'You can run Kowala Wallet Tools on your computer instead of from the GitHub servers. You can generatea a wallet completely offline and send transactions from the "Offline Transaction" page. ',
...
HELP_7_Desc_1               : 'Navigate to the "kCoin ve Tokens göndermeks" page. ',
...
HELP_9_Title                : '9) Is the "Send kCoin" page offline? ',
...
HELP_10_Desc_11             : 'On your online computer, paste the signed transaction into the text field in step #3 and click "SEND kCoin". This will broadcast your transaction. ',
...
HELP_14_Desc_1              : 'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experments) believe in window.crypto. In addition, Kowala Wallet Tools can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_SecCX_Title            : 'Güvenlik - Kowala Wallet Tools CX ',
