...
tx_notFound_4               : 'Please use the dropdown in the top-right & select a different ETH node (e.g. `ETH (kCoinscan.io)` or `ETH (Infura.io)` or `ETH (Kowala Wallet Tools)`) and check again.',
...
GEN_Help_12                 : 'Use it to unlock your wallet via Kowala Wallet Tools (or Mist, Geth, Parity and other wallet clients.) ',
...
NAV_SendkCoin               : 'Gửi kCoin và Tokens ',
...
MEW_Tagline                 : 'Open Source JavaScript Client-Side kCoin Wallet ',
CX_Tagline                  : 'Open Source JavaScript Client-Side kCoin Wallet Chrome Extension ',

/* Footer */
FOOTER_1                    : 'Free, open-source, client-side interface for generating Kowala wallets &amp; more. Interact with the Kowala blockchain easily &amp; securely.',
...
NODE_Warning                : 'Your node must be HTTPS in order to connect to it via Kowala Wallet Tools. You can [download the Kowala Wallet Tools repo & run it locally](https://github.com/kvhnuke/etherwallet/releases/latest) to connect to any node. Or, get free SSL certificate via [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Node Name',
NODE_Port                   : 'Node Port',
...
ADD_Ledger_2                : 'Mở Lên Ứng Dụng Của Kowala (Hoặc một ứng dụng của Hợp Đồng) ',
...
ADD_Ledger_0a               : 'Hảy mở lại trang Kowala Wallet Tools trên một kết nối có tính bảo mật (SSL) ',
ADD_Ledger_0b               : 'Sử dụng [Chrome](https://www.google.com/chrome/browser/desktop/) hoặc [Opera](https://www.opera.com/) Để mở lại trang Kowala Wallet Tools ',
ADD_Ledger_scan             : 'Kết nối với Ledger Wallet ',
ADD_MetaMask                : 'Connect to MetaMask ',
ADD_Ledger_scan             : 'Kết nối với Ledger Nano S ',
x_DigitalBitbox             : 'Digital Bitbox ',
ADD_DigitalBitbox_0a        : 'Hảy mở lại trang Kowala Wallet Tools trên một kết nối có tính bảo mật (SSL) ',
ADD_DigitalBitbox_0b        : 'Sử dụng [Chrome](https://www.google.com/chrome/browser/desktop/) hoặc [Opera](https://www.opera.com/) Để mở lại trang Kowala Wallet Tools ',
ADD_DigitalBitbox_scan      : 'Kết nối với Digital Bitbox ',
x_Secalot                   : 'Secalot ',
ADD_Secalot_0a              : 'Re-open Kowala Wallet Tools on a secure (SSL) connection ',
ADD_Secalot_0b              : 'Re-open Kowala Wallet Tools using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'Nếu bạn muốn sử dụng địa chỉ Ví này với Kowala Wallet Tools CX trong tương lai, bạn sẽ cần phải tự thêm vào lại bằng cách sử dụng tập tin Private Key / JSON và mật khẩu. ',
...
TranslatorName_2            : '[và Kowala Vietnam](https://www.ethereumvn.com) ',
...
HELP_Remind_Desc_1          : '**Kowala, Kowala Wallet Tools & Kowala Wallet Tools CX, và các nền tảng khác từ Javascript libraries mà chúng tôi sử dụng đang được phát triển một cách tích cực.** Mặc dù toàn bộ đã được chúng tôi kiễm tra rất kỹ lưỡng và hàng chục nghìn địa chỉ Ví đã được tạo thành công từ người sử dụng trên toàn cầu, nhưng vẫn có những vấn đề có thể xảy ra làm cho ETH của bạn bị mất đi. Xin vui lòng không nên đầu tư với số tiền nhiều hơn khả năng mà bạn đã cho rằng nó sẽ mất và hãy luôn cẩn thận. Trong trường hợp rủi ro xảy ra, chung tôi rất chân thành xin lỗi. Tuy nhiên **Chúng tôi sẽ không chịu bất cứ một trách nhiệm nào đối với số lượng kCoin mà bạn đã bị mất!**. ',
HELP_Remind_Desc_2          : 'Kowala Wallet Tools & Kowala Wallet Tools CX không phải "Ví Web". Vì vậy bạn không tạo tài khoản sau đó gửi số kCoin của bạn cho chúng tôi dễ giữ hộ. Toàn bộ Dữ liệu sẽ không bao giờ bị rò rỉ ra khỏi máy tính/trình duyệt của bạn. Chúng tôi xây dựng nó nhằm giúp người sử dụng có thể đễ dàng tạo mới, lưu trữ và truy cập thông tin Ví của bạn và tương tác với Blockchain. ',
...
HELP_0_Desc_1               : 'Kowala Wallet Tools giúp bạn có khả năng tạo Ví mới dùng dễ lưu trữ số lượng kCoin của ban bởi chính mình, Ví được tạo ra không nằm trên bất cứ một sàn giao dịch nào. Quá trình tạo Ví điễn ra hoàn toàn trên máy tính cá nhân của bạn chứ không phải trên hệ thống máy chủ của chúng tôi. Do đó, khi bạn khởi tạo một Ví mới, **bạn chịu trách nhiệm hoàn toàn về vấn đề sao lưu dữ liệu đối với Ví được tạo**. ',
...
HELP_0_Desc_5               : 'Gửi kCoin đến Ví mới này. ',
...
HELP_2a_Desc_2              : 'Lưu lại địa chỉ Ví. Bạn có thể giữ nó cho chính mình hoặc chia sẽ nó cho bất cứ ai. Người khác có thể gửi kCoin cho bạn thông qua địa chỉ Ví của bạn. ',
HELP_2a_Desc_3              : 'Private key. Không được chia sẽ Private key cho bất cứ ai. Private key rất cần thiết khi bạn muốn truy cập vào Ví và Gửi đi một lượng kCoin! hiện tại có 3 phiên bản lưu trữ dành cho Private Key: ',
...
HELP_2b_Title               : '2b) Làm thế nào dễ bảo mật Ví / offline / lưu trữ lạnh cùng với Kowala Wallet Tools? ',
...
HELP_3_Desc_1               : '**Trước khi bạn gửi số lượng kCoin vô Ví mới của bạn**, bạn nên chắc chắn rằng bạn đã truy cập vào Ví thành công. ',
HELP_3_Desc_2               : 'Đi đến trang "Xem Thông Tin Ví". ',
HELP_3_Desc_3               : 'Bạn hãy đi đến trang Kowala Wallet Tools "Xem Thông Tin Ví". ',
...
HELP_4_Title                : '4) Làm thế nào dễ gửi kCoin từ Ví này sang Ví khác ? ',
HELP_4_Desc_1               : 'Nếu như bạn dự định dễ chuyển một số lượng lớn kCoin, bạn nên gửi đi một lượng nhỏ đến Ví của bạn dễ thử nghiệm, nhằm xác định chắc chắn tất cả chức năng đều hoạt động đúng như dự định. ',
HELP_4_Desc_2               : 'Đi đến trang "Gửi kCoin và Tokens". ',
...
HELP_4_Desc_7               : 'Điền số lượng kCoin mà bạn muốn gửi đi.Hoặc bạn có thể chọn vào phần "Gửi toàn bộ số dư" nếu bạn muốn chuyển đi toàn bộ số kCoin mà bạn hiện có trong tài khoản. ',
...
HELP_4CX_Title              : '4) Làm thế nào dễ gửi đi kCoin bằng cách sử dụng Kowala Wallet Tools CX? ',
HELP_4CX_Desc_1             : 'Trước tiên, bạn cần phải thêm Ví của bạn vào. Sau khi thực hiện xong, Bạn sẽ có 2 lựa chọn: Chức năng "Gửi Nhanh" từ biểu tượng nằm trên thanh công cụ tiện ích của Google Chrome hoặc chọn vào "Gửi kCoin và Tokens" dễ đi đến trang trình duyệt. ',
...
HELP_4CX_Desc_7             : 'Điền số lượng kCoin mà bạn muốn gửi đi.Hoặc bạn có thể chọn vào phần "Gửi toàn bộ số dư" nếu bạn muốn chuyển đi toàn bộ số kCoin mà bạn hiện có trong tài khoản. ',
...
HELP_4CX_Desc_12            : 'Sử dụng trang "Gửi kCoin và Tokens" ',

HELP_5_Title                : '5) Làm thế nào dễ kích hoạt Kowala Wallet Tools với tính năng offline? ',
HELP_5_Desc_1               : 'Bạn hãy kích hoạt Kowala Wallet Tools trên máy tính của bạn thay thế cho việc chạy trên máy chủ của Github. Bạn có thể khởi tạo Ví mới hoàn toàn trong tình trạng offline và gửi giao dịch đi từ trang "Giao dịch Offline". ',
HELP_5_Desc_7               : 'Kowala Wallet Tools sẽ được chạy hoàn toàn trên máy tính của bạn. ',
HELP_5_Desc_8               : 'Trong trường hợp bạn chưa quen với việc sử dụng này, bạn cần nên giữ nguyên toàn bộ thư mục và chừa một phần dung lượng vừa đủ để chạy trang web, không chỉ riêng tập tin `index.html`. Không nên thử mở lên hoặc di chuyển bất cứ một tập tin nào trong thư mục. Nếu bạn lưu trữ một bản sao tập tin repo của Kowala Wallet Tools, chúng tôi khuyên bạn nên lưu trữ tập tin nén nhằm chắc chắn các nội dung của thư mục được giữ nguyên. ',
HELP_5_Desc_9               : 'Cũng như việc chúng tôi liên tục cập nhật Kowala Wallet Tools, vì vậy chúng tôi khuyên bạn nên cập nhận định kì cho các tập tin đã Lưu của định dạng repo. ',
...
HELP_7_Desc_1               : 'Đi đến trang "Gửi kCoin và Tokens". ',
...
HELP_7_Desc_14              : 'Sau đó một thông báo sẽ xuất hiện. Xác thực lại số lượng kCoin và địa chỉ đến. sau đó nhấn vào nút  "Có, Tôi chắc chắn! Hãy thực hiện giao dịch.". ',
...
HELP_8_Desc_1               : 'Kowala Wallet Tools không phải là Ví online. Bạn không cần phải đăng nhập và không có bất cứ gì được lưu lại trên máy chủ của chúng tôi. Đây chỉ đơn giản là một giao diện cho phép bạn tương tác với blockchain. ',
HELP_8_Desc_2               : 'Nếu Kowala Wallet Tools bị sập, bạn sẽ phải tìm một giải pháp khác (như là geth hoặc Ví Kowala / Mist) dễ tiếp tục thực hiện giao dịch. Nhưng bạn không cần thiết phải "Mang" kCoin của bạn ra khỏi Kowala Wallet Tools bởi vì số kCoin đó không nằm trong Kowala Wallet Tools. Bởi vì số kCoin đó đang nằm trong Ví Kowala được khởi tạo thông qua trang của chúng tôi. ',
HELP_8_Desc_3               : 'Bạn chỉ cần bỏ tập tin chứa định dạng mã hoá Private key của bạn vào và Geth/Mist sẽ tự động giải mã tập tin (mã hoá) trực tiếp bên trong  geth / Ví Kowala / Mist một cách dễ dàng. Xem câu hỏi #12. ',
HELP_8_Desc_4               : 'Ngoài ra, Khả năng xảy ra vấn đề trang Kowala Wallet Tools bị sập là rất khó. Cũng như việc chúng tôi không lưu trữ lại bất cứ dữ liệu gì vì vậy giá trị của nó sở hữu hoàn toàn bằng không. Nếu chúng tôi buộc phải  tháo tên miền này xuống, thì toàn bộ sẽ vẫn còn, tồn tại và công khai trên trang  [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Bạn có thể tải tập tin nén của nó và chạy nó trực tiếp trên máy tính của bạn. ',

HELP_8CX_Title              : '8) Những gì sẽ xảy ra néu Kowala Wallet Tools CX hoàn toàn biến mất? ',
...
HELP_8CX_Desc_2             : 'Điều đó cho thấy tầm **quan trọng** đối với việc sao lưu toàn bộ thông tin và dữ liệu Ví mới được khởi tạo từ bạn tại trang Kowala Wallet Tools CX. Và việc sao lưu dữ liệu là cách dự phòng tốt khi những vấn đề xấu có thể xảy ra đối với Kowala Wallet Tools CX hoặc máy tính của bạn, và nó giúp bạn có toàn bộ thông tin cần thiết dễ bạn có thể truy cập vào Ví và quản lý được số kCoin của bạn. xem lại phần #2a dễ rõ hơn về cách sao lưu dữ liệu. ',
HELP_8CX_Desc_3             : 'Nếu vì một lý do bất kì buộc Kowala Wallet Tools CX không tồn tại trên kho tiện ích của Chrome, bạn có thể tìm thấy mã nguồn trên Github và tải về máy của bạn. Xem phần #5 ở trên. ',

HELP_9_Title                : '9) Có phải trang "Gửi kCoin" là trang offline? ',
...
HELP_10_Desc_11             : 'Trên máy tính online của bạn, bạn hãy dán chữ ký giao dịch vào khung điền văn bản tại bước #3 và chọn nút "Gửi kCoin". Việc làm này sẽ phát sóng đi giao dịch của bạn. ',

HELP_12_Title               : '12) Làm thế nào dễ tôi sử dụng Ví được khởi tạo từ Kowala Wallet Tools trên geth / Ví Kowala / Mist? ',
HELP_12_Desc_1              : 'Bạn phải sử dụng tập tin chứa định dạng JSON dành cho Geth/Mist từ Kowala Wallet Tools v2+.... ',
...
HELP_12_Desc_7              : 'Truy cập Ví trên ứng dụng Ví Kowala. ',
...
HELP_12_Desc_20             : 'Việc này sẽ yêu cầu bạn thực hiện một mật khẩu mới. Và nó sẽ là mật khẩu mà bạn sử dụng tại geth / Ví Kowala / Mist . Lưu ý, Bạn phải ghi nhớ mật khẩu này. ',
HELP_12_Desc_21             : 'Sau khi hoàn thành việc nhập Ví trên ứng dụng, bạn nên xoá tập tin `nothing_special_delete_me.txt` ',
HELP_12_Desc_22             : 'Trong lần sử dụng ứng dụng Ví Kowala sau này, Tài khoản của bạn sẽ tự đọng liên kết và hiển thị dưới phần "Accounts". ',
...
HELP_12_Desc_26             : 'Việc này sẽ yêu cầu bạn thực hiện một mật khẩu mới. Và nó sẽ là mật khẩu mà bạn sử dụng tại geth / Ví Kowala / Mist . Lưu ý, Bạn phải ghi nhớ mật khẩu này. ',
HELP_12_Desc_27             : 'Sau khi hoàn thành việc nhập Ví trên ứng dụng, bạn nên xoá tập tin `nothing_special_delete_me.txt` ',
HELP_12_Desc_28             : 'Trong lần sử dụng ứng dụng Ví Kowala sau này, Tài khoản của bạn sẽ tự đọng liên kết và hiển thị dưới phần "Accounts". ',
...
HELP_14_Title               : '14) Một số trang khi khởi tạo Private key thông qua việc di chuyển con trỏ chuột máy tính trên màn hình. Kowala Wallet Tools không làm theo cách này. Các ký tự Private key được tạo ra trên trang Kowala Wallet Tools một cách an toàn nhất? ',
HELP_14_Desc_1              : 'Mặc dù chúng tôi hiểu với việc di chuyển chuột xung quanh màn hình như vậy sẽ khá thú vị, nhưng thực tế window.crypto sẽ đảm bảo việc tạo ra những "dữ liệu ngẫu nhiên" hơn đối với việc di chuyển chuột. Việc di chuyển chuột như vậy không phải là không an toàn, nhưng thông qua rất nhiều những thử nghiệm về mật mã khác thì chúng tôi hoàn toàn tin tưởng vào window.crypto. Ngoài ra, Kowala Wallet Tools còn được sử dụng trên những thiết bị cảm ứng. Đây là [Cuộc tranh cải tức giận giữa một redditor và Vitalik Buterin Liên quan đến vấn đề Di chuyển con chuột với window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_15_Desc_1              : 'Tài khoản của bạn chỉ tồn tại duy nhất trên một Blockchain Explorer và tài khoản được kích hoạt khi bởi chính nó khi bạn dùng tài khoản đó và chuyển kCoin vào tức khắc tài khoản sử dụng sẽ hiển thị trên hệ thống Blockchain Explorer thích hợp. ',
...
HELP_21_Title               : '21) có thể xảy ra trường hợp có một cá nhân nào đó sử dụng ngẫu nhiên một Private key dễ thấy được số dư tài khoản của một người khác và chuyển số kCoin đó vào địa chỉ mà cá nhân dó sở hữu hay không? ',
HELP_21_Desc_1              : 'Đối với phiên bản ngắn: Điều đó có thể xảy ra, nhưng việc chọn ngẫu nhiên dễ nhằm tìm kiếm một tài khoản chứa kCoin là một việc làm mất rất nhiều thời gian và cũng có thể mất cả vài chục năm dễ đạt được mục đích đó. bởi vậy trường hợp này được coi là rất khó dễ xảy ra. ',
HELP_21_Desc_2              : 'Phiên bản dài ELI5: Bởi vậy Kowala được dựa trên [Public Key Cryptography](https://en.wikipedia.org/wiki/Public-key_cryptography), Đặc biệt là [Mật mã đường cong Elliptic](https://eprint.iacr.org/2013/734.pdf) Được sử dụng rất rộng rãi, không chỉ duy nhất ở Kowala. Hầu hết các Server được bảo vệ thông qua ECC. Bitcoin cũng tương tự, cũng giống như SSH và TLS và rất nhiều thứ khác. Mã khoá của Kowala cụ thể bao gồm 256-bit ký tự, Đoạn mã đó dài và khó đoán hơn đoạn mã 128-bit và 192-bit, mặc dù 128-bit và 192-bit hiện cũng được dùng khá rộng rãi và vẫn được nhận định là rất bảo mật từ các chuyên gia. ',
HELP_21_Desc_3              : 'Tại đây bạn đang sở hữu private key và public key. private key có thể dùng thay thế cho public key, nhưng public key không thể dùng nhằm thay thế và dùng dễ phục hồi lại private key. Thực tế trên internet và các dữ liệu cần được bảo mật của thế giới đang sử dụng loại mật mã học này, có nghĩa nếu một cách nào đó nhằm dùng public key dễ phục hồi lại private key, Thì lượng kCoin mà bạn bị đánh cắp nó không phải là vấn đề lớn so với nhiều vấn đề mang tính quan trọng rất lớn của những tổ chức tài chính và chính phủ trên toàn cầu. ',
HELP_21_Desc_4              : 'Hiện tại chỉ khẳng định rằng nếu ai đó sở hữu được Private key của bạn thì thực sự họ mới có khả năng chuyển số kCoin trong tài khoản của bạn đi được. Giống như nếu ai đó có được mật khẩu email của bạn, họ có thể đọc và gửi email, hoặc mật khẩu tài khoản ngân hàng của bạn, họ mới có thể đánh cắp tiền của bạn đi được. Bạn có thể tải về định dạng Keystore bởi vì nó là định dạng đã mã hoá dữ liệu từ Private key của bạn cùng với mật khẩu giải mã khác. Trường hợp này giống như hiện tại bạn đang có một mật khẩu A nhưng được bảo vệ bởi một mật khẩu B khác và nó giúp tài khoản của bạn càng khó bị đánh mất hơn. ',
...
HELP_21_Desc_8              : 'Tất cả những giả đinh trên nhằm xác định rõ đoạn mã được tạo ra một cách hoàn toàn ngẫu nhiên. các mã khoá được tạo ra ở đây đáp ứng các tiêu chí, mà có thể tương tích đc với Jaxx và Mist/Geth. Ví Kowala là tất cả những gì tuyệt vời nhất. Keys generated by brainwallets do not, as a person\'s brain is not capable of creating a truly random seed. There have been a number of other issues regarding lack of entropy or seeds not being generated in a truly random way in Bitcoin-land, but that\'s a separate issue that can wait for another day. ',

HELP_SecCX_Title            : 'Bảo mật - Kowala Wallet Tools CX ',
...
HELP_SecCX_Desc_6           : 'Nếu chúng tôi mã hoá chúng, thì bạn phải điền mật khẩu khi bạn muốn xem số dư hiện tại của tài khoản bạn và xem tên gọi của tài khoản đó. Nếu như bạn cảm thấy đáp ứng nhu cầu bạn đã nêu, Chúng tôi cung cấp thêm lựa chọn khác dành cho bạn đó là Kowala Wallet Tools thay vì phải sử dụng Chrome Extension. ',
