...
tx_notFound_4               : 'Bruk rullegardinmenyen øverst til høyre og velg en annen ETH-node. (f.eks. `ETH (kCoinscan.io)` eller `ETH (Infura.io)` eller `ETH (Kowala Wallet Tools)`), og sjekk igjen.',
...
GEN_Help_12                 : 'Bruk den sammen med passordet du oppga til å låse opp lommeboken din via Kowala Wallet Tools (eller Mist, Geth, Parity og andre lommebok-klienter.) ',
...
NAV_SendkCoin               : 'Send kCoins & Tokens ',
...
/* General */
x_Access                    : 'Åpne ',
x_AddessDesc                : 'Din `adresse` kalles også for `kontonummer` eller `offentlig nøkkel`. Det er denne du sender til folk så de kan sende deg kCoin eller Tokens. Find det fargerike adresse-ikonet. Forsikre deg om at det er likt med ikonet på papir-lommeboken din og ellers hver gang du oppgir adressen din. ',
...
MEW_Tagline                 : 'Open Source JavaScript Client-Side kCoin Wallet ', /* Intentionally not translated */
CX_Tagline                  : 'Open Source JavaScript Client-Side kCoin Wallet Chrome Extension ', /* Intentionally not translated */

/* Footer */
FOOTER_1                    : 'Et åpen-kildekode-, javascript-, klient-side-verktøy for å opprette Kowala-lommebøker & sende transaksjoner. ',
FOOTER_1b                   : 'Skapt av ',
...
ADD_Ledger_2                : 'Åpne Kowala-applikasjonen (eller kontraktsapplikasjonen) ',
...
ADD_Ledger_0a               : 'Åpne Kowala Wallet Tools på nytt på en sikker (SSL) forbindelse. ',
ADD_Ledger_0b               : 'Åpne Kowala Wallet Tools på nytt med [Chrome](https://www.google.com/chrome/browser/desktop/) eller [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Åpne Kowala Wallet Tools på nytt på en sikker (SSL) forbindelse. ',
ADD_DigitalBitbox_0b        : 'Åpne Kowala Wallet Tools på nytt med [Chrome](https://www.google.com/chrome/browser/desktop/) eller [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'Hvis du ønsker å bruke denne lommeboken med din Kowala Wallet Tools Chrome-utvidelse i fremtiden, må du manuelt legge den til igjen ved å bruke den private nøkkelen/JSON og passord. ',
...
HELP_1_Desc_1               : 'Gå til "Send kCoins & Tokens"-siden. ',
...
HELP_2b_Title               : '2b) Hvordan kan jeg lagre ether sikkert / offline / "kaldt" med Kowala Wallet Tools? ',
...
HELP_3_Desc_3               : 'Naviger til Kowala Wallet Tools sin "Vis lommebok-info"-side. ',
...
HELP_4_Desc_2               : 'Naviger til "Send kCoins & Tokens"-siden. ',
...
HELP_4CX_Title              : '4) Hvordan sender jeg ether med Kowala Wallet Tools CX (Chrome-utvidelsen)? ',
HELP_4CX_Desc_1             : 'Først må du legge til en lommebok. Når du har gjort det, har du 2 muligheter: den kjappe "Send"-funksjonaliteten fra Chrome-utvidelsesikonet eller "Send kCoins & Tokens"-siden. ',
...
HELP_4CX_Desc_12            : 'Bruk "Send kCoins & Tokens"-siden ',

HELP_5_Title                : '5) Hvordan kan jeg bruke Kowala Wallet Tools offline/lokalt? ',
HELP_5_Desc_1               : 'Du kan bruke Kowala Wallet Tools på datamaskinen din i stedet for fra GitHub-serverne. Du kan opprette en lommebok fullstendig frakoblet fra internett, og sende transaksjoner fra "Send offline"-siden. ',
HELP_5_Desc_7               : 'Kowala Wallet Tools kjører nå utelukkende på din datamaskin. ',
HELP_5_Desc_8               : 'I tilfelle du ikke er så vant med dette: du må beholde hele mappen for å kunne kjøre nettsiden, ikke bare `index.html`. Ikke rør eller flytt rundt på noe i mappen. Hvis du lagrer en backup av Kowala Wallet Tools-repoet for framtiden, anbefaler vi å kun lagre zip-fila så du kan være sikker på at innholdet i mappen forblir intakt. ',
HELP_5_Desc_9               : 'Siden vi oppdaterer Kowala Wallet Tools hele tiden, anbefaler vi at du oppdaterer din lagrede versjon av repoet jevnlig. ',
...
HELP_7_Desc_1               : 'Naviger til "Send kCoins & Tokens"-siden. ',
...
HELP_8_Desc_1               : 'Kowala Wallet Tools er ikke en nett-lommebok (web wallet). Du har ingen innlogging og ingenting blir noensinne lagret på våre servere. Det er ganske enkelt et grensesnitt som tillater deg å samhandle med blokkjeden. ',
HELP_8_Desc_2               : 'Hvis Kowala Wallet Tools går ned, må du finne en annen måte (som f.eks. geth eller Kowala Wallet / Mist) å gjøre det på. Men du vil ikke trenge å "hente" eteren din ut av Kowala Wallet Tools, fordi den ikke befinner seg i Kowala Wallet Tools. Den befinner seg i den lommeboka/kontoen som du opprettet ved hjelp av nettsiden vår. ',
HELP_8_Desc_3               : 'Du kan nå svært enkelt importere din ukrypterte private nøkkel og dine Geth/Mist-format (krypterte) filer direkte inn i geth / Kowala Wallet / Mist. Se spørsmål #12 nedenfor. ',
HELP_8_Desc_4               : 'I tillegg er sannsynligheten for at vi tar ned Kowala Wallet Tools svært liten. Det koster oss nesten ingenting å opprettholde den siden vi ikke lagrer noen informasjon. Hvis vi tar ned domenet, er det fortsatt, og vil alltid være, offentlig tilgjengelig på [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Du kan laste ned zip-fila der og kjøre den lokalt. ',

HELP_8CX_Title              : '8) Hva skjer hvis Kowala Wallet Tools CX (Chrome-utvidelsen) forsvinner? ',
...
HELP_8CX_Desc_2             : 'Når det er sagt, så er det **svært viktig** at du sikkerhetskopierer all din informasjon for alle lommebøkene som du har opprettet med Kowala Wallet Tools CX. På den måten vil du fortsatt ha all nødvendig informasjon for å få tilgang til eteren din selv om noe skulle hende med Kowala Wallet Tools CX eller datamaskinen din. Se spørsmål #2a ang. hvordan du sikkerhetskopierer lommebøkene dine. ',
HELP_8CX_Desc_3             : 'Hvis Kowala Wallet Tools CX av en eller annen grunn skulle forsvinne fra Chrome Store, så kan du finne kildekoden på Github og laste den inn manuelt. Se #5 ovenfor. ',

HELP_9_Title                : '9) Er "Send kCoins & Tokens"-siden offline? ',
...
HELP_10_Desc_11             : 'Lim inn den signerte transaksjonen i tekstfeltet i steg #3 på den tilkoblede maskinen og klikk "Send kCoins & Tokens". Dette vil kringkaste transaksjonen din. ',

HELP_12_Title               : '12) Hvordan kan jeg importere en lommebok opprettet med Kowala Wallet Tools til geth / Kowala Wallet / Mist? ',
HELP_12_Desc_1              : 'Ved å bruke en Geth/Mist JSON-fil fra Kowala Wallet Tools v2+.... ',
...
HELP_12_Desc_7              : 'Åpne "Kowala Wallet"-programmet. ',
...
HELP_12_Desc_20             : 'Du vil bli bedt om å lage et nytt passord. Dette er passordet du vil bruke i geth / Kowala Wallet / Mist hver gang du skal sende en transaksjon, så ikke glem det. ',
HELP_12_Desc_21             : 'Etter at du har lykkes med å importere kontoen, slett `ikke_noe_spesielt_slett_meg.txt` ',
HELP_12_Desc_22             : 'Neste gangen du åpner "Kowala Wallet"-programmet, vil kontoen din være listet under "Accounts". ',
...
HELP_12_Desc_26             : 'Du vil bli bedt om å lage et nytt passord. Dette er passordet du vil bruke i geth / Kowala Wallet / Mist hver gang du skal sende en transaksjon, så ikke glem det. ',
HELP_12_Desc_27             : 'Etter at du har lykkes med å importere kontoen, slett `ikke_noe_spesielt_slett_meg.txt` ',
HELP_12_Desc_28             : 'Neste gangen du åpner "Kowala Wallet"-programmet, vil kontoen din være listet under "Accounts". ',
...
HELP_13_Desc_1              : 'Dette betyr at du ikke har nok kCoin på kontoen din til å dekke gas-kostnaden. Hver transaksjon (inkludert token- og kontrakt-transaksjoner) krever gas, og gas betales med kCoin. Tallet som vises er beløpet som kreves for å dekke transaksjonskostnaden i Wei (1 ETH = 10^18 Wei). Ta dette tallet, del det på `1000000000000000000`, og trekk fra kCoin-beløpet som du prøvde å sende (hvis du prøvde å sende kCoin). Dette vil gi deg kCoin-beløpet som du mangler på (trenger å sende til) denne kontoen for å gjennomføre transaksjonen. ',

HELP_14_Title               : '14) Noen nettsider randomiserer genereringen av den private nøkkelen via musebevegelser. Kowala Wallet Tools gjør ikke dette. Er metoden som Kowala Wallet Tools bruker til å generere tilfeldige tall sikker? ',
HELP_14_Desc_1              : 'Selv om musebevegelses-metoden er smart og vi skjønner hvorfor folk liker den, så er realiteten at window.crypto sikrer mer entropi (tilfeldighet) enn musebevegelser. Musebevegelses-metoden er ikke usikker, men det er bare det at vi (og mange andre kryptoeksperter) har tro på window.crypto. I tillegg kan Kowala Wallet Tools også benyttes på fingerstyrte enheter. Her er en [konversasjon mellom en sint redditor og Vitalik Buterin angående musebevegelser versus window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) og her er [window.crypto w3 spesifikasjonen](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_15_Desc_1              : 'Kontoer vil kun dukke opp i en blokkjede-utforsker når kontoen har hatt aktivitet&mdash;for eksempel, når du har overført kCoin til den. ',
...
HELP_21_Title               : '21) Kan ikke hvem som helst legge inn tilfeldige private nøkler, sjekke saldoen, og sende kCoin til sin egen adresse? ',
HELP_21_Desc_1              : 'Kortversjonen: ja, men å finne en konto som inneholder kCoin ville tatt lengre tid enn universets levealder...så...nei. ',
HELP_21_Desc_2              : 'Lang ELI5-versjon: Kowala er basert på [Offentlig nøkkel-kryptografi](https://en.wikipedia.org/wiki/Public-key_cryptography), og mer spesifikt [Elliptic curve cryptography](https://eprint.iacr.org/2013/734.pdf), som er svært utbredt, ikke bare i Kowala. De fleste servere er beskyttet via ECC. Bitcoin bruker den samme, likeså SSH og TLS og mange flere. Kowala-nøklene er 256-bit nøkler, som er sterkere enn 128-bit og 192-bit, som også er mye brukt og fortsatt betraktes som sikre av ekspertene. ',
HELP_21_Desc_3              : 'I denne har du en privat nøkkel og en offentlig nøkkel. Den private nøkkelen kan utlede den offentlige nøkkelen, men den offentlige nøkkelen kan ikke brukes for å finne den private nøkkelen. Det faktum at internett og verdens hemmeligheter bruker denne kryptografien betyr at hvis det blir funnet en måte å gå fra offentlige til private nøkler på, så vil dine tapte kCoin være det minste av alles problemer. ',
...
HELP_SecCX_Desc_6           : 'Hvis vi skulle kryptere disse, måtte du ha oppgitt et passord hver gang du ønsket å se saldo for kontoene dine eller vise kallenavnene. Hvis dette bekymrer deg, anbefaler vi deg å bruke Kowala Wallet Tools i stedet for denne Chrome-utvidelsen. ',
...
HELP_Sec_Desc_3             : 'Vi kommer ikke til å ta pengene dine eller stjele dine private nøkler. Det er ingen ondsinnet kode på denne siden. Faktisk er "Send kCoins & Tokens"-siden fullstendig klient-drevet. Det betyr at all koden blir kjørt på ** din datamaskin ** og det blir aldri lagret eller overført noe sted. ',
