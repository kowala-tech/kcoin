...
tx_notFound_4               : 'Utilizza il menu a discesa in alto a destra e scegli un altro nodo ETH (ad esempio `ETH (kCoinscan.io)` o `ETH (Infura.io)` o `ETH (Kowala Wallet Tools)`) e ricontrolla.',
...
GEN_Help_12                 : 'Usalo per sbloccare il portafoglio tramite Kowala Wallet Tools (o Mist, Geth, Parity e altri client.) ',
...
NAV_SendkCoin               : 'Invia ether e token ',
...
/* Footer */
FOOTER_1                    : 'Interfaccia gratuita, open source, lato client per generare portafogli Kowala e altro. Interagisci con la *blockchain* Kowala facilmente e in modo sicuro. Controlla bene l\'URL ( myetherwallet.com ) prima di sbloccare un portafoglio.',
FOOTER_1b                   : 'Creato da ',
...
sidebar_donation            : 'Kowala Wallet Tools è un servizio gratuito e open-source votato alla tua privacy e sicurezza. Più donazioni riceviamo, più tempo dedichiamo a creare nuove funzionalità, considerare i tuoi commenti, e darti ciò che vuoi. Siamo solo due persone che provano a cambiare il mondo. Ci aiuti? ',
sidebar_donate              : 'Dona ',
...
ADD_Warning_1               : 'Puoi aggiungere qualunque conto da "osservare" nella scheda dei portafogli senza caricare una chiave privata. Ciò ** non ** significa che avrai accesso a quel portafoglio, né che potrai trasferire gli kCoin lì contenuti. ',
...
MYWAL_Content_3             : 'Se vorrai utilizzare questo portafoglio con Kowala Wallet Tools CX in futuro, dovrai ri-aggiungerlo manualmente tramite la chiave privata/JSON e password. ',
...
ADD_Ledger_0a               : 'Devi accedere a Kowala Wallet Tools tramite una connessione sicura (SSL / HTTPS) per poterti collegare. ',
ADD_Ledger_0b               : 'Riapri Kowala Wallet Tools utilizzando [Chrome](https://www.google.com/chrome/browser/desktop/) o [Opera](https://www.opera.com/) ',
ADD_Ledger_1                : 'Collega il tuo Ledger Wallet ',
ADD_Ledger_2                : 'Apri l\'applicazione Kowala (o l\'applicazione di un contratto) ',
...
ADD_DigitalBitbox_0a        : 'Riapri Kowala Wallet Tools su una connessione sicura (SSL) ',
ADD_DigitalBitbox_0b        : 'Riapri Kowala Wallet Tools utilizzando [Chrome](https://www.google.com/chrome/browser/desktop/) o [Opera](https://www.opera.com/) ',
...
NODE_Warning                : 'Il tuo nodo deve utilizzare HTTPS per potertici collegare da Kowala Wallet Tools. Puoi [scaricare il repository di Kowala Wallet Tools ed eseguirlo in locale](https://github.com/kvhnuke/etherwallet/releases/latest) per collegarti ad altri tipi di nodo. Oppure, ottieni un certificato SSL gratuito tramite [LetsEncrypt](https://letsencrypt.org/)',
...
HELP_2b_Title               : '2b) Come implemento un portafoglio offline in maniera sicura con Kowala Wallet Tools? ',
...
HELP_3_Desc_3               : 'Vai alla pagina "Informazioni portafoglio" su Kowala Wallet Tools. ',
...
HELP_4CX_Title              : '4) Come invio degli ether utilizzando Kowala Wallet Tools CX? ',
...
HELP_5_Title                : '5) Come faccio ad eseguire Kowala Wallet Tools offline/in locale? ',
HELP_5_Desc_1               : 'Puoi eseguire Kowala Wallet Tools sul tuo computer invece che dai server di GitHub. Puoi generare un portafoglio completamente offline e inviare transazioni dalla pagina "Invia Offline". ',
HELP_5_Desc_7               : 'Kowala Wallet Tools è ora in esecuzione completamente sul tuo computer. ',
HELP_5_Desc_8               : 'In caso tu non abbia molta confidenza, ti serve l\'intera cartella per poter eseguire il sito web, non solo `index.html`. Non toccare né spostare nulla del contenuto della cartella. Se stai conservando un backup del repository Kowala Wallet Tools per il futuro, ti consigliamo di conservare soltanto il file ZIP in modo da assicurarti che i contenuti della cartella rimangano intatti. ',
HELP_5_Desc_9               : 'Dal momento che stiamo costantemente aggiornando Kowala Wallet Tools, ti consigliamo di aggiornare periodicamente la tua versione locale del repository. ',
...
HELP_8_Desc_1               : 'Kowala Wallet Tools non è un portafoglio web. Non hai un login e niente viene mai salvato nei nostri server. È semplicemente un\'interfaccia che ti consente di interagire con la *blockchain*. ',
HELP_8_Desc_2               : 'Se Kowala Wallet Tools va giù, dovrai trovare un altro modo (come geth o Kowala Wallet / Mist) per fare quello che facciamo noi. Ma non dovrai "tirare fuori" i tuoi ether da Kowala Wallet Tools perché non si trovano in Kowala Wallet Tools. Sono in qualunque portafoglio tu abbia generato tramite il nostro sito. ',
HELP_8_Desc_3               : 'Ora puoi importare direttamente e molto facilmente in geth / Kowala Wallet / Mist la tua chiave privata non crittografata e i tuoi file in formato Geth/Mist (crittografati). Vedi la domanda n. 12 qui sotto. ',
HELP_8_Desc_4               : 'Inoltre, la probabilità che tiriamo giù Kowala Wallet Tools è prossima allo zero. Non ci costa praticamente nulla mantenerlo dal momento che non stiamo memorizzando alcuna informazione. Se anche disattivassimo il dominio, è ancora, e sarà sempre, disponibile pubblicamente su [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Puoi scaricare lo ZIP da lì ed eseguirlo in locale. ',

HELP_8CX_Title              : '8) Che succede se Kowala Wallet Tools CX sparisce? ',
...
HELP_8CX_Desc_2             : 'Detto ciò, è **molto importante** che tu faccia un backup di tutte le informazioni relative a ogni nuovo portafoglio generato con Kowala Wallet Tools CX. In questo modo se succede qualcosa a Kowala Wallet Tools CX or al tuo computer avrai ancora tutte le informazioni necessarie ad accedere ai tuoi ether. Vedi la domanda n. 2a per come salvare i tuoi portafogli. ',
HELP_8CX_Desc_3             : 'Se per qualche ragione Kowala Wallet Tools CX sparisce dal Chrome Store, puoi trovare i sorgenti su Github e caricare l\'estensione manualmente. Vedi la domanda n. 5 qui sopra. ',
...
HELP_12_Title               : '12) Come faccio a importare un portafoglio creato con Kowala Wallet Tools in geth / Kowala Wallet / Mist? ',
HELP_12_Desc_1              : 'Con un file JSON Geth/Mist generato da Kowala Wallet Tools v2+.... ',
...
HELP_12_Desc_7              : 'Apri l\'applicazione Kowala Wallet. ',
...
HELP_12_Desc_20             : 'Ti verrà chiesto di creare una nuova password. È la password che userai in geth / Kowala Wallet / Mist ogni volta che invierai una transazione, quindi non dimenticarla. ',
HELP_12_Desc_21             : 'A importazione conclusa positivamente, cancella `niente_di_speciale_cancellami.txt` ',
HELP_12_Desc_22             : 'Alla prossima apertura dell\'applicazione Kowala Wallet, il tuo conto sarà mostrato sotto "Accounts". ',
...
HELP_12_Desc_26             : 'Ti verrà chiesto di creare una nuova password. È la password che userai in geth / Kowala Wallet / Mist ogni volta che invierai una transazione, quindi non dimenticarla. ',
HELP_12_Desc_27             : 'A importazione conclusa positivamente, cancella `niente_di_speciale_cancellami.txt` ',
HELP_12_Desc_28             : 'Alla prossima apertura dell\'applicazione Kowala Wallet, il tuo conto sarà mostrato sotto "Accounts". ',
...
HELP_14_Title               : '14) Certi siti inizializzano il generatore di numeri casuali per la generazione della chiave privata tramite i movimenti del mouse. Kowala Wallet Tools non lo fa. La generazione di numeri casuali di Kowala Wallet Tools è sicura? ',
HELP_14_Desc_1              : 'Sebbene usare i movimenti del mouse sia ingegnoso, e comprendiamo perché piaccia, la realtà è che window.crypto assicura maggiore entropia rispetto ai tuoi movimenti del mouse. Non che i movimenti del mouse siano insicuri, è solo che noi (e un sacco di altri critto-esperimenti) crediamo in window.crypto. Oltretutto, Kowala Wallet Tools può essere utilizzato su dispositivi touch. Qui c\'è una [conversazione fra un utente di reddit arrabbiato e Vitalik Buterin su movimenti del mouse contro window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) e qui c\'è [la specifica del w3 di window.crypto](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_21_Desc_2              : 'Versione lunga in termini semplici: Kowala si basa sulla [Crittografia a chiave pubblica](https://it.wikipedia.org/wiki/Crittografia_a_chiave_pubblica), nello specifico [Crittografia a curva ellittica](https://eprint.iacr.org/2013/734.pdf) (ECC) che è ampiamente utilizzata, non solo in Kowala. La maggior parte dei server sono protetti tramite ECC. Anche Bitcoin la usa, oltre a SSH e TLS e a un sacco di altra roba. Le chiavi di Kowala nello specifico sono di 256 bit, che sono più robuste di 128 bit e 192 bit, che sono anch\'esse ampiamente utilizzate e sono tuttora considerate sicure dagli esperti. ',
...
HELP_21_Desc_8              : 'Certo, tutto ciò assume che le chiavi siano generate in una maniera veramente casuale e con sufficiente entropia. Le chiavi generate qui soddisfano questi criteri, come anche Jaxx e Mist/geth. I portafogli Kowala sono tutti piuttosto buoni. Le chiavi generate dai *brainwallet* non lo sono, dal momento che il cervello di una persona non è capace di creare un seme veramente casuale. Ci sono stati un numero di altri problemi relativi alla mancanza di entropia o a semi non generati in maniera veramente casuale nel mondo di Bitcoin, ma quella è un\'altra questione di cui non parleremo oggi. ',

HELP_SecCX_Title            : 'Sicurezza - Kowala Wallet Tools CX ',
...
HELP_SecCX_Desc_6           : 'Se crittografassimo questi elementi dovresti inserire una password ogni volta in cui volessi vedere il saldo del tuo conto o i nomi dei portafogli. Se ciò ti preoccupa, ti consigliamo di usare Kowala Wallet Tools invece di questa estensione di Chrome. ',
