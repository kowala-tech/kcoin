...
tx_notFound_4               : 'กรุณาใช้กล่อง dropdown ที่มุมขวาบน & เลือก ETH Node อื่น (เช่น `ETH (kCoinscan.io)` หรือ `ETH (Infura.io)` หรือ `ETH (Kowala Wallet Tools)`) และตรวจสอบอีกครั้ง',
...
GEN_Help_12                 : 'ใช้เพื่อปลดล็อกกระเป๋าของคุณผ่าน Kowala Wallet Tools (หรือ Mist, Geth, Parity หรือโปรแกรมกระเป๋าอื่นๆ) ',
...
/* General */
x_Access                    : 'เข้าใช้ ',
x_AddessDesc                : 'ที่อยู่ของคุณ หรือสามารถเรียกอีกอย่างว่า `Account #` หรือ `กุญแจสาธารณะ (Public Key)` คือสิ่งที่คุณสามารถแชร์ให้ผู้อื่น เพื่อรอรับ kCoin หรือ Token ได้ เพียงมองหาไอคอนของที่อยู่และตรวจสอบให้แน่ใจว่ามันตรงกับกระเป๋ากระดาษของคุณ หรือเมื่อใดก็ตามที่คุณป้อนที่อยู่ของคุณ',
x_Address                   : 'ที่อยู่ของคุณ ',
x_Cancel                    : 'ยกเลิก ',
x_CSV                       : 'ไฟล์ CSV (ไม่ได้ถูกเข้ารหัส) ',
x_Download                  : 'ดาวน์โหลด ',
x_Json                      : 'ไฟล์ JSON (ไม่ได้ถูกเข้ารหัส) ',
x_JsonDesc                  : 'เนื้่อหานี้ไม่ถูกเข้ารหัส ซึ่งเป็น กุญแจส่วนตัว (Private Key) ของคุณที่อยู่รูปแบบ JSON ซึ่งหมายความว่าผู้อื่นที่เข้าถึง JSON นี้ จะสามารถเข้าถึงกระเป๋า & kCoin ของคุณได้โดยไม่จำเป็นต้องรู้รหัสผ่านเลย ',
...
/* Header */
CX_Tagline                  : 'โอเพ่นซอร์ส JavaScript ฝั่งไคลเอนต์สำหรับสร้างกระเป๋า kCoin ผ่าน Chrome Extension ',
...
MEW_Tagline                 : 'โอเพ่นซอร์ส JavaScript ฝั่งไคลเอนต์สำหรับสร้างกระเป๋า kCoin ',
MEW_Warning_1               : 'ตรวจสอบ URL ทุกครั้ง ก่อนเข้าใช้กระเป๋าของคุณหรือสร้างกระเป๋าใหม่ ระวังเว็บไซต์ลอกเลียนแบบประสงค์ร้าย! ',

/* Footer */
FOOTER_1                    : 'ฟรี, โอเพ่นซอร์ส, อินเตอร์เฟสฝั่งไคลเอนต์สำหรับสร้างกระเป๋า Kowala &amp; อื่นๆอีกมากมาย และทำธุรกรรมผ่านบล็อคเชนของ Kowala ได้อย่างง่ายดาย &amp; ปลอดภัย อย่าลืมตรวจสอบ URL ( myetherwallet.com ) ทุกครั้งก่อนเข้าใช้กระเป๋าของคุณ',
...
sidebar_donation            : 'Kowala Wallet Tools ให้บริการฟรี, และเป็นโอเพ่นซอร์สเพื่อความเป็นส่วนตัว และความปลอดภัยของคุณ ยิ่งเราได้รับการบริจาคมากเท่าไหร่เราก็ยิ่งมีเวลาเพื่อสร้างฟีเจอร์ใหม่ๆ มากขึ้นเท่านั้น, พร้อมรับฟังข้อเสนอแนะ, และตอบสนองตามความต้องการของผู้ใช้ ซึ่งเราเป็นแค่ทีมสองคนที่อยากจะเปลี่ยนแปลงโลกใบนี้ สนใจช่วยเราไหม? ',
...
ADD_Ledger_2                : 'เปิด Kowala application (หรือ contract application) ',
...
ADD_Ledger_0a               : 'คุณต้องเข้าใช้ Kowala Wallet Tools ผ่านทางการเชื่อมต่อที่ปลอดภัย (SSL / HTTPS) ถึงจะสามารถเชื่อมต่อได้ ',
ADD_Ledger_0b               : 'เปิด Kowala Wallet Tools อีกครั้งด้วย [Chrome](https://www.google.com/chrome/browser/desktop/) หรือ [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'เปิด Kowala Wallet Tools อีกครั้งผ่านการเชื่อมต่อที่ปลอดภัย (SSL) ',
ADD_DigitalBitbox_0b        : 'เปิด Kowala Wallet Tools อีกครั้งด้วย [Chrome](https://www.google.com/chrome/browser/desktop/) หรือ [Opera](https://www.opera.com/) ',
...
ADD_Warning_1               : 'คุณสามารถเพิ่มบัญชีเข้า "รายการติดตาม" จากแท็บของกระเป๋าโดยไม่ต้องอัพโหลด private key ซึ่งการกระทำนี้ ** ไม่ได้ ** หมายความว่าคุณสามารถเข้าถึงกระเป๋านี้ได้ หรือสามารถส่ง kCoin ออกจากกระเป๋าได้ ',
...
MYWAL_Content_3             : 'ถ้าหากคุณต้องการจะใช้กระเป๋านี้ร่วมกับ Kowala Wallet Tools CX ในอนาคต คุณจำเป็นจะต้องเพิ่มกระเป๋าใหม่อีกครั้งด้วย private key/JSON และรหัสผ่าน ',
...
SENDModal_Content_4         : 'หมายเหตุ: หากคุณพบข้อผิดพลาด โดยส่วนใหญ่แล้วคุณจำเป็นที่จะต้องเพิ่ม kCoin เข้าบัญชีเพื่อใช้เป็นค่าแก๊สในการส่ง Token และค่าแก๊สจะถูกจ่ายด้วย kCoin ',
...
NODE_Warning                : 'Node ของคุณจะต้องเป็น HTTPS เพื่อที่จะเชื่อมต่อกับ Kowala Wallet Tools คุณสามารถ [ดาวน์โหลดซอร์สโค้ดจาก Kowala Wallet Tools repo & รันบนเครื่องคอมพิวเตอร์ของคุณ](https://github.com/kvhnuke/etherwallet/releases/latest) เพื่อเชื่อมต่อกับ Node ใดๆ หรือสร้างใบรับรอง SSL ผ่าน [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'ชื่อ Node',
