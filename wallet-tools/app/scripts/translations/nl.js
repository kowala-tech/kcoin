...
tx_notFound_4               : 'Gebruik het drop-down menu in de rechterbovenhoek & selecteer een andere ETH node (bijvoobeeld `ETH (kCoinscan.io)` of `ETH (Infura.io)` of `ETH (Kowala Wallet Tools)`) en check opnieuw.',
...
GEN_Help_12                 : 'Gebruik het enkel om je wallet te openen via Kowala Wallet Tools (of Mist, Geth, Parity en andere wallet clients.) ',
...
NAV_SendkCoin               : 'Verzend kCoin & Tokens ',
...
x_AddessDesc                : 'Je Adres wordt ook wel je `Account #` of je Publieke Sleutel ("Public Key") genoemd. Dit is wat je deelt met anderen zodat ze je kCoin of Tokens kunnen toesturen. Zie ook je kleurrijke adres icoon. Zorg ervoor dat het matched met je paper wallet & waar dan ook wanneer je je adres ergens invoerd. Dit icoon is een makkelijke manier om je adres te herkennen. ',
x_Address                   : 'Je Adres ',
x_Cancel                    : 'Annuleren ',
x_CSV                       : 'CSV bestand (onversleuteld) ',
x_Download                  : 'Download ',
x_Json                      : 'JSON Bestand (onversleuteld) ',
x_JsonDesc                  : 'Dit is het onversleutelde, JSON formaat van je prive sleutel ("Private Key"). Dit betekend dat je het wachtwoord niet nodig hebt, maar ook dat een ieder die je JSON bestand vind toegang heeft tot je wallet & kCoin zonder wachtwoord. ',
...
/* Header */
CX_Tagline                  : 'Open Source JavaScript Client-Side kCoin Wallet Chrome Extensie ',
...
/* Footer */
FOOTER_1                    : 'Een gratis, open source, client-side interface om Kowala wallets te genereren &amp; meer. Wissel op een gemakkelijke &amp; veilige manier informatie uit met de Kowala blockchain. Dubbel-check de URL/link ( myetherwallet.com ) alvorens je wallet te openen.',
...
ADD_Ledger_2                : 'Open de Kowala applicatie (of een contract applicatie) ',
...
ADD_Ledger_0a               : 'Her-open Kowala Wallet Tools met een veilige (SSL) verbinding ',
ADD_Ledger_0b               : 'Her-open Kowala Wallet Tools door gebruik te maken van [Chrome](https://www.google.com/chrome/browser/desktop/) of [Opera](https://www.opera.com/) ',
ADD_Ledger_scan             : 'Verbind met Ledger Wallet ',
x_Trezor                    : 'TREZOR ',
ADD_Trezor_scan             : 'Verbind met TREZOR ',
ADD_MetaMask                : 'Verbind met MetaMask ',
x_DigitalBitbox             : 'Digital Bitbox ',
ADD_DigitalBitbox_0a        : 'Her-open Kowala Wallet Tools met een veilige (SSL) verbinding ',
ADD_DigitalBitbox_0b        : 'Her-open Kowala Wallet Tools door gebruik te maken van [Chrome](https://www.google.com/chrome/browser/desktop/) of [Opera](https://www.opera.com/) ',
...
ADD_Warning_1               : 'Je kunt elk account toevoegen als "bekijken" in het wallets tabblad zonder de prive sleutel te uploaden. Dit betekend ** niet ** dat je toegang hebt tot deze wallet, noch dat je er kCoin vanuit kunt versturen. ',
...
MYWAL_Content_3             : 'Als je deze wallet in de toekomst nog wilt gebruiken met Kowala Wallet Tools CX, zul je het met de hand moeten toevoegen door gebruik te maken van de prive sleutel/JSON en wachtwoord. ',
...
NODE_Warning                : 'Je node dient HTTPS te zijn om met Kowala Wallet Tools te kunnen verbinden. Je kunt de [Kowala Wallet Tools repo downloaden](https://github.com/kvhnuke/etherwallet/releases/latest) en lokaal uitvoeren en vervolgens met iedere node verbinden. Of, verkrijg een gratis SSL certificaat via [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Node Naam',
...
HELP_0_Desc_5               : 'Verzend kCoin naar dit nieuwe wallet. ',
...
HELP_2b_Title               : '2b) Hoe doe ik veilig / offline / cold storage met Kowala Wallet Tools? ',
...
HELP_3_Desc_1               : 'Zorg **voordat je enige kCoin naar je wallet verstuurd** dat je controleerd dat je er toegang toe hebt. ',
HELP_3_Desc_2               : 'Navigeer naar de "Bekijk Wallet Info" pagina. ',
HELP_3_Desc_3               : 'Navigeer naar de Kowala Wallet Tools "Bekijk Wallet Info" pagina. ',
...
HELP_4_Title                : '4) Hoe stuur ik kCoin van het ene wallet naar het ander? ',
...
HELP_4_Desc_2               : 'Navigeer naar de "Verzend kCoin en Tokens" pagina. ',
...
HELP_4CX_Title              : '4) Hoe verzend ik kCoin met Kowala Wallet Tools CX? ',
HELP_4CX_Desc_1             : 'Ten eerste heb je een wallet nodig. Zodra je die hebt, heb je 2 opties: De "VerzendSnel" functionaliteit vanuit het Chrome Extensie icoon of de "Verzend kCoin en Tokens" pagina. ',
...
HELP_4CX_Desc_12            : 'Maak gebruik van de "Verzend kCoin en Tokens" Pagina ',

HELP_5_Title                : '5) Hoe voer ik Kowala Wallet Tools offline/lokaal uit? ',
HELP_5_Desc_1               : 'Je kunt Kowala Wallet Tools uitvoeren op je eigen computer in plaats van op de GitHub servers. Je kunt een wallet volledig offline genereren en transacties versturen met behulp van de "Offline Transactie" pagina. ',
HELP_5_Desc_7               : 'Kowala Wallet Tools draait nu volledig op jouw computer. ',
HELP_5_Desc_8               : 'Voor het geval dat je er niet bekend mee bent: je hebt de volledige map nodig om de site lokaal te draaien, niet alleen het `index.html` bestand. Laat alle bestanden in de map met rust en ga ze niet verplaatsen. Als je een back-up wilt bewaren van de Kowala Wallet Tools repo voor de toekomst, raden we je aan om alleen de ZIP te bewaren zodat je zeker weet dat de inhoud intact blijft. ',
HELP_5_Desc_9               : 'Gezien we Kowala Wallet Tools continu updaten, raden we je aan om regelmatig je opgeslagen versie van de repo bij te werken. ',
...
HELP_8_Desc_1               : 'Kowala Wallet Tools is geen web wallet. Je hoeft niet in te loggen en er zal nooit iets van je op onze servers worden bewaard. Onze website is enkel een interface om toegang te verkrijgen tot de blockchain. ',
HELP_8_Desc_2               : 'Als Kowala Wallet Tools er mee stopt, zul je een andere manier moeten zien te vinden (zoals geth of Kowala Wallet / Mist) om te doen wat wij doen. Maar wat je niet zult hoeven te doen is je kCoin uit Kowala Wallet Tools halen omdat het niet in Kowala Wallet Tools zit. Je kCoin zit in in welk wallet dan ook je op onze site hebt gegenereerd. ',
HELP_8_Desc_3               : 'Je kunt je  onversleutelde (unencrypted) prive sleutel en je Geth/Mist Formaat (encrypted) bestanden heel gemakkelijk en direct in geth / Kowala Wallet / Mist importeren. Zie onderstaande vraag #12. ',
HELP_8_Desc_4               : 'Daarnaast is de kans dat wij Kowala Wallet Tools offline halen is miniem tot onmogelijk. Het kost ons vrijwel niets om de site in stand te houden omdat we geen informatie opslaan. Als we toch het domijn offline halen, is het ook altijd nog publiekelijk beschikbaar op [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Je kunt daar de ZIP downloaden en het lokaal draaien. ',

HELP_8CX_Title              : '8) Wat gebeurd er als Kowala Wallet Tools CX verdwijnt? ',
...
HELP_8CX_Desc_2             : 'Dat gezegd hebbende, is het dan ook **erg belangrijk** dat je een back-up maakt van je wallets die met Kowala Wallet Tools CX zijn gegenereerd. Als er iets met Kowala Wallet Tools CX of jouw computer gebeurd blijft op die manier je wallet bewaard, en heb alle noodzakelijke informatie bij de hand om toegang tot je kCoin te verkrijgen. Zie vraag #2a om te leren hoe een back-up van je wallet kunt maken. ',
HELP_8CX_Desc_3             : 'Als om wat voor reden dan ook Kowala Wallet Tools CX verdwijnt van de Chrome Store, kunt je het altijd nog handmatig laden met de broncode van Github. Zie #5 hierboven. ',

HELP_9_Title                : '9) Is de "Verzend kCoin en Tokens" pagina offline? ',
...
HELP_12_Title               : '12) Hoe importeer ik een Kowala Wallet Tools  wallet in geth / Kowala Wallet / Mist? ',
HELP_12_Desc_1              : 'Door gebruik te maken van een Geth/Mist JSON bestand van Kowala Wallet Tools v2+.... ',
...
HELP_12_Desc_7              : 'Open de Kowala Wallet applicatie. ',
...
HELP_12_Desc_20             : 'Je zal gevraagd worden om een nieuw wachtwoord. Dit is het wachtwoord wat je zult gebruiken in geth / Kowala Wallet / Mist elke keer als je een transactie verzend, dus zorg dat je dit niet vergeet. ',
HELP_12_Desc_21             : 'Verwijder het bestand `niets_bijzonders_verwijder_mij.txt` na een geslaagde import. ',
HELP_12_Desc_22             : 'De volgende keer dat je de Kowala Wallet applicatie opent, zal je account worden vermeld onder "Accounts". ',
...
HELP_12_Desc_26             : 'Je zal gevraagd worden om een nieuw wachtwoord. Dit is het wachtwoord wat je zult gebruiken in geth / Kowala Wallet / Mist elke keer als je een transactie verzend, dus zorg dat je dit niet vergeet. ',
HELP_12_Desc_27             : 'Verwijder het bestand `niets_bijzonders_verwijder_mij.txt` na een geslaagde import. ',
HELP_12_Desc_28             : 'De volgende keer dat je de Kowala Wallet applicatie opent, zal je account worden vermeld onder "Accounts". ',
...
HELP_13_Desc_1              : 'Dit betekend dat je account onvoldoende kCoin bevat om de kosten voor het vereiste gas te dekken. Elke transactie (inclusief token en contract transacties) vereisen gas en dit gas wordt betaald in kCoin. Het weergegeven nummer is de hoeveelheid die voor de transactie vereist in Wei. Neem dit nummer, deel het door `1000000000000000000`, en trek daarvan de hoeveelheid kCoin die je probeerde te verzenden af (als je probeerde kCoin te versturen). Dit geeft je de hoeveelheid kCoin die je dient te versturen naar het account om de transactie te maken. ',

HELP_14_Title               : '14) Sommige sites zorgen voor een willekeurigheid (seed) bij het genereren van de prive sleutel via muis bewegingen. Kowala Wallet Tools doet dit niet. Is de wikkeleurigheid (random number generation) van Kowala Wallet Tools wel veilig? ',
HELP_14_Desc_1              : 'Hoewel het bewegen van de muis een slimme truck is en we begrijpen waarom mensen dit een goed idee vinden, is de werkelijkheid dat "window.crypto" een grotere willekeurigheid (hogere entropie) zeker stelt dan je muisbewegingen. De muisbewegingen zijn niet onveilig, echter wij (en enorm veel andere crypto experimenten) geloven in "window.crypto". Bovendien kan Kowala Wallet Tools gebruikt worden op touchscreen apparaten. Hier vind je een [conversatie tussen een boze redditor en Vitalik Buterin over de muisbewegingen v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_15_Desc_1              : 'Adresen zullen enkel in een blockchain explorer worden weergegeven zodra er activiteit op een account heeft plaats gevonden. Bijvoorbeeld, zodra je er wat kCoin naar toe verzonden hebt. ',
...
HELP_21_Desc_2              : 'De lange ELI5 versie: Kowala is gebasserd op [Publieke Sleutel Cryptografie](https://en.wikipedia.org/wiki/Public-key_cryptography), en meer specifiek op [Elliptische curve cryptografie](https://eprint.iacr.org/2013/734.pdf) wat op grote schaal gebruikt wordt, niet alleen in Kowala. De meeste van onze servers zijn beveiligd via ECC. Bitcoin maakt hier ook gebruik van, net als SSH, TLS en vele andere dingen. De specifieke Kowala sleutels zijn 256-bit sleutels, welke sterker zijn dan 128-bit en 192-bit, terwijl die ook op grote schaal gebruikt worden en no steeds als veilig worden beschouwd door experts. ',
...
HELP_SecCX_Desc_6           : 'Als we deze items zouden versleutelen, zou je iedere keer dat je je saldo of nicknames wilt checken je wachtwoord moeten invoeren. Als je je hierover zorgen maakt, raden we je aan om gebruik te maken van Kowala Wallet Tools in plaats van deze Chrome Extensie. ',
