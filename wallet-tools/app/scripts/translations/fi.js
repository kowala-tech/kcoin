...
NAV_SendkCoin               : 'Lähetä kCoiniä ja Tokeneita ',
...
x_JsonDesc                  : 'Tämä on salaamaton JSON tiedosto yksityisestä salausavaimestasi. Tämä tarkoittaa että et tarvitse salasanaa mutta kuka tahansa joka löytää JSON tiedostosi saa pääsyn lompakkoosi ja sen sisältämään kCoiniin ilman salasanaa. ',
...
MEW_Tagline                 : 'Avoimen Lähdekoodin JavaScript kCoin Lompakko ',
CX_Tagline                  : 'Avoimen Lähdekoodin JavaScript Chrome Laajennus ',

/* Footer */
FOOTER_1                    : 'Avoimen lähdekoodin, javascript työkalu Kowala lompakkojen luomista & varojen siirtoja varten. ',
FOOTER_1b                   : 'Luonut ',
...
ADD_Warning_1               : 'Voit lisätä minkä tahansa tilin jota "seurata" lompakkojen välilehdessä ilman yksityisen salausavaimesi lähettämistä. Tämä ** ei ** tarkoita että sinulla olisi pääsy tähän lompakkoon, tai että voit siirtää kCoiniä siitä. ',
...
MYWAL_Content_3             : 'Jos tahdot käyttää tätä lompakkoa Kowala Wallet Tools CX:si kanssa tulevaisuudessa, sinun täytyy manuaalisesti uudelleen-lisätä se käyttäen yksityistä salausavaintasi/JSONia ja salasanaa. ',
...
HELP_4_Desc_2               : 'Navigate to the "Lähetä kCoiniä ja Tokeneita" page. ',
...
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Lähetä kCoiniä ja Tokeneita" page. ',
...
HELP_4CX_Desc_12            : 'Using "Lähetä kCoiniä ja Tokeneita" Page ',
...
HELP_7_Desc_1               : 'Navigate to the "Lähetä kCoiniä ja Tokeneita" page. ',
...
HELP_9_Title                : '9) Is the "Lähetä kCoiniä ja Tokeneita" page offline? ',
