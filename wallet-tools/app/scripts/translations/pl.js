...
tx_notFound_4               : 'Użyj menu w prawym górnym rogu aby wybrać inny węzeł ETH (np. `ETH (kCoinscan.io)` lub `ETH (Infura.io)` lub `ETH (Kowala Wallet Tools)`) i sprawdź ponownie.',
...
NAV_SendkCoin               : 'Wyślij kCoin i Tokeny ',
...
MEW_Tagline                 : 'Portfel Kowala - Open Source, JavaScript, Client-Side ',
CX_Tagline                  : 'Portfel Kowala, Rozszerzenie Chrome - Open Source, JavaScript, Client-Side ',

/* Footer */
FOOTER_1                    : 'Narzędzie do generowania portfeli Kowala i wysyłania transakcji - otwarto-źródłowe, javascrypt\'owe, strony klienta ',
FOOTER_1b                   : 'Twórcy: ',
FOOTER_2                    : 'Darowizny: ',
...
MYWAL_Content_3             : 'Jeśli będziesz chciał w przyszłości używać ten portfel ze swoim Kowala Wallet Tools CX, będziesz musiał go ponownie dodać używając klucza prywatnego/pliku JSON i hasła. ',
...
ADD_Ledger_2                : 'Otwórz aplikację Kowala (lub aplikację kontraktu) ',
...
ADD_Ledger_0a               : 'Otwórz Kowala Wallet Tools ponownie na bezpiecznym połączeniu (SSL) ',
ADD_Ledger_0b               : 'Otwórz Kowala Wallet Tools w [Chrome](https://www.google.com/chrome/browser/desktop/) lub [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Otwórz Kowala Wallet Tools ponownie na bezpiecznym połączeniu (SSL) ',
ADD_DigitalBitbox_0b        : 'Otwórz Kowala Wallet Tools w [Chrome](https://www.google.com/chrome/browser/desktop/) lub [Opera](https://www.opera.com/) ',
...
HELP_0_Desc_1               : 'Kowala Wallet Tools daje Ci możliwość generowania nowych portfeli abyś mógł przechowywać własne środki samodzielnie, nie na portalu wymiany walut. Ten proces odbywa się w całości na Twoim komputerze, nie na naszych serwerach. Z tego powodu, gdy generujesz nowy portfel, **to Ty jesteś odpowiedzialny za jego bezpieczne przechowywanie**. ',
...
HELP_2b_Title               : '2b) Jak mogę utworzyć portfel w 100% odizolowany od sieci globalnej (Cold Wallet) wykorzystując Kowala Wallet Tools? ',
...
HELP_3_Desc_3               : 'Przejdź na zakładkę "Wyświetl informacje o portfelu" na stronie Kowala Wallet Tools. ',
...
HELP_4_Title                : '4) Jak wysłać kCoin z jednego portfela na inny? ',
...
HELP_4_Desc_2               : 'Przejdź na zakładkę "Wyślij kCoin". ',
...
HELP_4CX_Title              : '4)Jak wysłać kCoin używając Kowala Wallet Tools CX? ',
HELP_4CX_Desc_1             : 'Najpierw musisz dodać portfel. Po dodaniu portfela masz 2 możliwości do wyboru: funkcja "Wyślij" z ikony Rozszerzenia Chrome lub zakładka "Wyślij kCoin" ze strony "Moje Portfele". ',
...
HELP_4CX_Desc_12            : 'Używając zakładki "Wyślij kCoin" ',

HELP_5_Title                : '5) Jak uruchomić Kowala Wallet Tools offline/lokalnie? ',
HELP_5_Desc_1               : 'Możesz uruchomić Kowala Wallet Tools lokalnie ze swojego komputera zamiast z serwerów GitHub\'a. Możesz wygenerować portfel całkowicie offline\'owo i wysyłać transakcje z zakładki "Wyślij offline". ',
HELP_5_Desc_7               : 'Kowala Wallet Tools działa teraz w całości na Twoim komputerze. ',
HELP_5_Desc_8               : 'W razie gdybyś nie wiedział, musisz zachować cały folder, aby strona działała prawidłowo, nie tylko `index.html`. Nie ruszaj i nie przenoś nic innego w folderze. Jeżeli zachowujesz kopie repozytorium Kowala Wallet Tools na przyszłość, zalecamy przechowywać je w formie spakowanego pliku ZIP, aby mieć pewność, że jego zawartość się nie zmieniła. ',
HELP_5_Desc_9               : 'Ponieważ ciągle aktualizujemy Kowala Wallet Tools, zalecamy co jakiś czas aktualizować  zapisaną wersję repozytorium. ',
...
HELP_7_Desc_1               : 'Przejdź na zakładkę "Wyślij kCoin i Tokeny". ',
...
HELP_8_Desc_1               : 'Kowala Wallet Tools nie jest usługą portfela internetowego. Nie posiadasz loginu i nic nie jest zapisywane na naszych serwerach. To tylko interfejs, który pozwala korzystać z sieci Kowala. ',
HELP_8_Desc_2               : 'Jeżeli Kowala Wallet Tools zostanie wyłączona, musiałbyś znaleźć inny sposób (jak Kowala Wallet / Mist) na korzystanie z sieci Kowala. Nie musiałbyś jednak wypłacić swoich środków z Kowala Wallet Tools, ponieważ one nie znajdują się na Kowala Wallet Tools, a na portfelach, które zostały wygenerowane za pomocą naszej strony. ',
HELP_8_Desc_3               : 'Możesz w każdej chwili, w bardzo prosty sposób, zaimportować swoje nieszyfrowane klucze prywatne lub szyfrowane pliki w formacie Geth/Mist wprost do geth / Kowala Wallet / Mist. Zobacz pytanie 12 poniżej. ',
HELP_8_Desc_4               : 'W dodatku prawdopodobieństwo zamknięcia przez nas strony Kowala Wallet Tools jest bliskie zeru. Koszty utrzymania strony są prawie żadne, ponieważ nie przechowujmy żadnych informacji. Jeśli nawet strona zostanie zamknięta, jest ona również i zawsze będzie publicznie dostępna na [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Możesz ściągnąć paczkę ZIP i uruchomić Kowala Wallet Tools lokalnie na własnym komputerze. ',

HELP_8CX_Title              : '8) Co się stanie jeżeli Kowala Wallet Tools CX zniknie? ',
...
HELP_8CX_Desc_2             : 'Z tego powodu, jest **niezmiernie ważnym** aby wykonywać kopie bezpieczeństwa wszystkich nowych portfeli wygenerowanych za pomocą Kowala Wallet Tools CX. W ten sposób, jeżeli cokolwiek stanie się Kowala Wallet Tools CX lub Twojemu komputerowi, wciąż będziesz miał wszelkie niezbędne informacje potrzebne aby odzyskać dostęp do Twoich portfeli. Zobacz punkt 2a aby dowiedzieć się jak wykonać kopie bezpieczeństwa. ',
HELP_8CX_Desc_3             : 'Jeżeli z jakiegoś powodu Kowala Wallet Tools CX zniknie z Chrome Store, możesz wciąż znaleźć kod źródłowy na Github\'ie i załadować manualnie do Chrome. Zobacz pkt. 5 powyżej. ',

HELP_9_Title                : '9) Czy zakładka "Wyślij kCoin" działa offline? ',
...
HELP_12_Title               : '12) Jak zaimportować portfel utworzony w Kowala Wallet Tools do geth / Kowala Wallet / Mist? ',
HELP_12_Desc_1              : 'Używając pliku Keystore Geth/Mist z Kowala Wallet Tools v2+.... ',
...
HELP_12_Desc_7              : 'Uruchom aplikację Kowala Wallet. ',
...
HELP_12_Desc_20             : 'Zostaniesz zapytany o hasło. To będzie hasło portfela w geth / Kowala Wallet / Mist, które należy podać przy każdej transakcji, nie zapomnij tego hasła. ',
HELP_12_Desc_21             : 'Po zaimportowaniu portfela, usuń `nic_specjalnego_usun_mnie.txt` ',
HELP_12_Desc_22             : 'Po ponownym uruchomieniu aplikacji Kowala Wallet Twój portfel pojawi się na zakładce "Accounts". ',
...
HELP_12_Desc_26             : 'Zostaniesz zapytany o hasło. To będzie hasło portfela w geth / Kowala Wallet / Mist, które należy podać przy każdej transakcji, nie zapomnij tego hasła. ',
HELP_12_Desc_27             : 'Po zaimportowaniu portfela, usuń `nic_specjalnego_usun_mnie.txt` ',
HELP_12_Desc_28             : 'Po ponownym uruchomieniu aplikacji Kowala Wallet Twój portfel pojawi się na zakładce "Accounts". ',
...
HELP_13_Desc_1              : 'Oznacza to, że nie posiadasz wystarczającej ilości kCoin na koncie, aby pokryć koszty paliwa. Każda transakcja (przesyłanie tokenów lub interakcja z kontraktem) wymaga paliwa, które jest opłacane w kCoin\'ach. Wyświetlona wartość jest ilością potrzebną na pokrycie kosztów transakcji w Wei\'ach. Podziel tą liczbę przez `1000000000000000000` i odejmij wartość kCoin, którą chciałeś wysłać (jeśli wysyłałeś kCoin). Otrzymasz wartość, jaką musisz przesłać na swoje konto, aby wykonać transakcję.',

HELP_14_Title               : '14) Niektóre strony wykorzystują ruchy myszką przy generowaniu klucza prywatnego. Kowala Wallet Tools tego nie robi. Czy generator liczb losowych w Kowala Wallet Tools jest bezpieczny? ',
HELP_14_Desc_1              : 'Chociaż generowanie liczb losowych przy udziale ruchów myszki jest sprytnie pomyślane i rozumiemy dlaczego ludzie to lubią, to jednak rzeczywistość jest taka, że window.crypto zapewnia większą entropię niż ruchy myszką. Generowanie z ruchów myszki nie jest niebezpieczne, ale my (oraz znaczna liczba innych ekspertów kryptografii) wierzymy w window.crypto. W dodatku Kowala Wallet Tools może być używane na urządzeniach dotykowych. Tutaj można przeczytać [rozmowę rozeźlonego reddit\'ora i Vitalik\'a Buterin\'a odnośnie ruchów myszki kontra window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) a tutaj jest [specyfikacja window.crypto w3](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_21_Desc_2              : 'Długa wersja (dla przedszkolaka): Kowala bazuje na [Kryptografii Klucza Publicznego (ECC)](https://pl.wikipedia.org/wiki/Kryptografia_klucza_publicznego), a dokładnie na [Kryptografii Krzywych Eliptycznych](https://eprint.iacr.org/2013/734.pdf) które są bardzo szeroko stosowane, nie tylko w Kowala. Większość serwerów jest chroniona przez ECC. Kolejne przykłady to Bitcoin, SSH, TLS i wiele innych. Klucze w Kowala to dokładnie odmiana 256-bitowa, która jest silniejsza niż 128-bitowa i 192-bitowa, które również są wciąż szeroko stosowane oraz uznawane przez ekspertów za bezpieczne. ',
HELP_21_Desc_3              : 'W tego typu zabezpieczeniu mamy 2 klucze: klucz prywatny i klucz publiczny. Z klucza prywatnego możemy szybko otrzymać klucz publiczny, ale otrzymanie klucza prywatnego z klucza publicznego jest niemożliwe. Biorąc pod uwagę, że cały internet i wszystkie sekrety świata używają tej metody kryptograficznej oznacza, że gdyby istniał sposób na otrzymanie klucza prywatnego z publicznego, to utrata Twoich środków z konta Kowala byłaby najmniejszym zmartwieniem w świecie. ',
