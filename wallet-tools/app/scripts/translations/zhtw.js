...
/* Onboarding */
ONBOARD_welcome_title           :  '歡迎來到 Kowala Wallet Tools',
...
ONBOARD_welcome_content__4      :  '什麼是KWT? ',
ONBOARD_welcome_content__5      :  'Kowala Wallet Tools 是一個免費、開源、運行於用戶端的介面。',
...
ONBOARD_bank_title              :  'Kowala Wallet Tools 不是一間銀行',
...
ONBOARD_interface_title         :  'Kowala Wallet Tools 是一個介面',
ONBOARD_interface_content__1    :  '當你在 Kowala Wallet Tools 建立一個帳戶，你是在產生一串密碼數列：你的私鑰和你的公鑰 (地址)。',
...
tx_notFound_4               : '請用右上角的下拉式選單來選取其他 ETH 節點 (例如： `ETH (kCoinscan.io)` 、 `ETH (Infura.io)` 或 `ETH (Kowala Wallet Tools)`) 並再檢查一次。',
...
GEN_Help_12                 : '用它在 Kowala Wallet Tools (或Mist、Geth、Parity和其他錢包) 來解鎖你的錢包 ',
...
sidebar_donation            : 'Kowala Wallet Tools是注重你的隱私和安全的免費、開源服務。如果有更多捐贈，我們就能花更多時間開發新功能、聽取你的建議並且滿足你的需要。我們只是兩個想要改變世界的人。幫助我們？ ',
sidebar_donate              : '捐贈 ',
sidebar_thanks              : '謝謝你!!! ',
...
ADD_Ledger_0b               : '以 [Chrome](https://www.google.com/chrome/browser/desktop/) 或 [Opera](https://www.opera.com/) 瀏覽器重新開啟Kowala Wallet Tools',
...
ADD_DigitalBitbox_0b        : '以 [Chrome](https://www.google.com/chrome/browser/desktop/) 或 [Opera](https://www.opera.com/) 瀏覽器重新開啟Kowala Wallet Tools',
...
MYWAL_Content_3             : '如果你在未來還想在Kowala Wallet Tools擴充功能上操作此錢包，你必須使用私鑰或JSON檔和密碼來重新新增它。 ',
...
NODE_Warning                : '你的節點必須使用HTTPS安全連線的方式才能夠由 Kowala Wallet Tools 連接到它。 你可以下載 [Kowala Wallet Tools repo](https://github.com/kvhnuke/etherwallet/releases/latest) 並建立起一個你的節點來連接至其他的節點。或著從 [LetsEncrypt](https://letsencrypt.org/) 獲取免費的SSL憑證',
NODE_Name                   : '節點名稱',
NODE_Port                   : '節點連線的端口號碼',
