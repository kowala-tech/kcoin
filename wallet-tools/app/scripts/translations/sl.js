...
NAV_SendkCoin               : 'Pošlji kCoin in Žetone ',
...
MEW_Tagline                 : 'Odprto-kodni JavaScript kCoin Denarnica za splošno uporabo ',
CX_Tagline                  : 'Odprto-kodni JavaScript kCoin Denarnica Chrome Dodatek za splošno uporabo ',

/* Footer */
FOOTER_1                    : 'Odprto-kodni, JavaScript, orodje za generiranje kCoin Denarnic in pošiljanje transakcij za splošno uporabo. ',
...
sidebar_donation            : 'Kowala Wallet Tools je brezplačna, odprto-kodna, platforma, ki skrbi za vaše privatne informacije in vašo varnost. Več donacij ko dobimo, več časa lahko posvetimo ustvarjanju novih funkcij, ter se lahko bolje posvetimo vašim željam, da tko da vam vedno lahko ponudimo karseda najboljši produkt. Kowala Wallet Tools je ekipa dveh ljudi, ki se trudi spremeniti svet. Hvaležni bomo vaše pomoči. ',
...
ADD_Warning_1               : 'V zavihek denarnic lahko dodate naslov kateregakoli obstoječega kCoin računa, ki ga želite opazovati brez da vnesete njegov osebni ključ. S tem ** ne ** dobite dostopa do računa ki ga opazujete, in ne morete izplačati Ethra s tega računa. ',
...
HELP_4_Desc_2               : 'Navigate to the "Pošlji kCoin in Žetone" page. ',
...
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Pošlji kCoin in Žetone" page. ',
...
HELP_4CX_Desc_12            : 'Using "Pošlji kCoin in Žetone" Page ',
...
HELP_7_Desc_1               : 'Navigate to the "Pošlji kCoin in Žetone" page. ',
...
HELP_9_Title                : '9) Is the "Pošlji kCoin in Žetone" page offline? ',
