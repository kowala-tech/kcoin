...
X_HelpfulLinks_4                :  'Kowala Wallet Toolsから、またはKowala Wallet Toolsへ移行するには', /*Migrating to/from Kowala Wallet Tools*/
...
ENS_Helper_21                   :  'Kowala Name Service再開日について！', /*Announcing the Kowala Name Service Relaunch Date!*/
...
EOS_06                          :  'kCoin/トークンの送出ページに移動する', /*Go to Send kCoins & Tokens Page*/
...
/* Onboarding */
ONBOARD_welcome_title           :  'いらっしゃいませ！ Kowala Wallet Tools へようこそ！', /*Welcome to Kowala Wallet Tools*/
...
ONBOARD_welcome_content__4      :  'KWTとは何か', /*What is KWT*/
ONBOARD_welcome_content__5      :  'Kowala Wallet Toolsは、無料で、オープンソースの、クライアントサイド・インターフェイスです。', /*Kowala Wallet Tools is a free, open-source, client-side interface.*/
...
ONBOARD_bank_title              :  'Kowala Wallet Toolsは金融機関に非ず', /*Kowala Wallet Tools is not a Bank*/
...
ONBOARD_interface_title         :  'Kowala Wallet Toolsは窓口である', /*Kowala Wallet Tools is an Interface*/
ONBOARD_interface_content__1    :  'Kowala Wallet Toolsを使って口座を開設すると、一組の暗号数列、すなわち秘密鍵と公開鍵（アドレス）が作成されます。', /*When you create an account on Kowala Wallet Tools you are generating a cryptographic set of numbers: your private key and your public key (address).*/
...
ONBOARD_bank_title__alt         :  'Kowala Wallet Toolsは金融機関に非ず', /*KWT isn\'t a Bank*/
...
ONBOARD_blockchain_content__4   :  'ブロックチェーンの中にあるブロックは全て、Kowala Wallet ToolsやMetaMask、Exodus、Mist、Geth、Parity、その他様々な場所から送られてきた個々の取引記録で構成されています。', /*The blocks in the blockchain are made up of all the individual transactions sent from Kowala Wallet Tools, MetaMask, Exodus, Mist, Geth, Parity, and everywhere else.*/
ONBOARD_blockchain_content__5   :  'Kowala Wallet Toolsや[etherscan.io](https://etherscan.io)で残高や取引記録を確認すると、見えるのは私たちのシステムの中身ではなく、ブロックチェーン上にあるデータです。', /*When you see your balance on Kowala Wallet Tools or view your transactions on [etherscan.io](https://etherscan.io), you are seeing data on the blockchain, not in our personal systems.*/
ONBOARD_blockchain_content__6   :  '大事なことなのでもう一度: **私たちは金融機関ではありません。**', /*Again: **we are not a bank**.*/
ONBOARD_interface_title__alt    :  'KWTは窓口である', /*KWT is an Interface*/
...
ONBOARD_blockchain_title__alt   :  'そもそもブロックチェーンとは何か', /*WTF is a Blockchain?*/
ONBOARD_point_title__alt        :  'それならKWTは何ができるの？', /*What\'s the Point of KWT then?*/
ONBOARD_whymew_title            :  'Kowala Wallet Toolsができないなら、つまりどういうこと？', /*If Kowala Wallet Tools can\'t do those things, what\'s the point?*/
...
ONBOARD_whymew_content__6       :  'もし、少し不安だけれどもKWTを使いたければ、[ハードウェアウォレットを入手しましょう](https://myetherwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)！(英語) あなたの鍵を安全に保管してくれます。', /*If you are scared but want to use KWT, [get a hardware wallet](https://myetherwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! These keep your keys secure.*/
...
ONBOARD_final_content__3        :  'KWT+Metamaskの設定方法', /*How to Set up KWT + MetaMask*/
ONBOARD_final_content__4        :  'オフライン/ローカル環境でのKWTの使い方', /*How to Run KWT Offline / Locally*/
...
/* Old */
ADD_DigitalBitbox_0a        : 'セキュア通信（SSL)で、Kowala Wallet Toolsを開きなおしてください。',
ADD_DigitalBitbox_0b        : '[Chrome](https://www.google.com/chrome/browser/desktop/)か[Opera](https://www.opera.com/)で、Kowala Wallet Toolsを開きなおしてください',
ADD_DigitalBitbox_scan      : 'Digital Bitboxに接続する',
ADD_Secalot_0a              : 'セキュア通信（SSL)で、Kowala Wallet Toolsを開きなおしてください。',
ADD_Secalot_0b              : '[Chrome](https://www.google.com/chrome/browser/desktop/)か[Opera](https://www.opera.com/)で、Kowala Wallet Toolsを開きなおしてください',
...
ADD_Ledger_0a               : 'セキュア通信（SSL)で、Kowala Wallet Toolsを開きなおしてください。',
ADD_Ledger_0b               : '[Chrome](https://www.google.com/chrome/browser/desktop/)か[Opera](https://www.opera.com/)で、Kowala Wallet Toolsを開きなおしてください',
ADD_Ledger_1                : 'Ledger Walletに接続する',
ADD_Ledger_2                : 'kCoinreumアプリケーション（または契約アプリケーション）を開く',
...
ADD_Warning_1               : '任意のアカウントをウォッチする目的で、秘密鍵をアップロードせずにお財布タブに追加することできます。これによってお財布の操作や、kCoinの送受金が可能になるわけではありません。',
...
CX_Tagline                  : 'オープンソース JavaScript クライアントサイド kCoin ウォレット Chrome Extension',
...
PARITY_TooCheapToReplace    : "(parity-08) トランザクション手数料が低すぎます。ご利用のノードの最低額を満たしていません（最低額: (d+), 指定: (d+)）。ガス価格かガスリミットを上げてください。[詳細はこちら](https://myetherwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)",
  ...
  FOOTER_1                    : 'Kowalaウォレットを作成するための、無料で、オープンソースの、クライアントサイド・インターフェイス。Kowalaのブロックチェーンを簡単且つ安全に操作。お財布解錠の前に、URL( myetherwallet.com )を再確認してください。',
FOOTER_1b                   : '制作者:',
...
GEN_Help_12                 : 'Kowala Wallet Tools上でこれを使用し、お財布を解錠してください（Mist、Geth、Parityやその他のお財布クライアントでも可）。', /*Use it to unlock your wallet via Kowala Wallet Tools (or Mist, Geth, Parity and other wallet clients.)*/
...
MEW_Tagline                 : 'オープンソース JavaScript クライアントサイド kCoin ウォレット',
...
MYWAL_Content_3             : '今後Kowala Wallet Tools CXでこのお財布を使用するためには、秘密鍵/JSONとパスワードを手動で追加する必要があります。',
...
NODE_Warning                : 'Kowala Wallet Tools 経由で接続するためには、HTTPSノードが必要です。[Kowala Wallet Toolsをレポジトリからダウンロードして、ローカル環境で実行させて](https://github.com/kvhnuke/etherwallet/releases/latest)、いずれかのノードに接続することもできます。または、無料のSSL証明書を[LetsEncrypt](https://letsencrypt.org/)から入手してください。',
NODE_Name                   : 'ノード名',
NODE_Port                   : 'ノードポート',
...
SENDModal_Content_1         : '次のkCoin/トークンの送出準備完了:',
...
sidebar_donation            : 'Kowala Wallet Toolsは、無料で、オープンソースのサービスで、皆さまのプライバシーとセキュリティのための全力を尽くしています。寄付が増えることによって、新機能の作成やフィードバックの反映に多くの時間を費やし、よりユーザーの皆さまのご希望に沿ったものを提供することが可能になります。私たちは、たった二人で世界を変えようとしています。どうかお手伝いいただけませんか？',
sidebar_donate              : '寄付する',
...
tx_notFound_4               : '画面右上のドロップダウンメニューから、別のノード（例: `ETH (kCoinscan.io)`・`ETH (Infura.io)`・`ETH (Kowala Wallet Tools)`）を選択し、もう一度確認してください',
...
x_TxHash                    : 'Txハッシュ',
x_Access                    : 'アクセス',
x_AddessDesc                : 'お財布のアドレスとは、`アカウント番号`や`公開鍵`とも呼ばれ、他の人と共有してkCoinやトークンを送ってもらうためのものです。カラフルなアドレスアイコンがあるでしょう。自分のお財布紙情報（ペーパーウォレット）や、お財布アドレスを入力する際に、同じアイコンであることを確認してください。',
x_Address                   : 'あなたのアドレス',
x_Cancel                    : '取り消す',
x_CSV                       : 'CSVファイル（未暗号化）',
x_Download                  : 'ダウンロード',
x_Json                      : 'JSONファイル（未暗号化）',
x_JsonDesc                  : 'これはパスワードが不要な、暗号化されていないJSON形式の秘密鍵です。これを持っていれば、誰でもパスワードを使わずにあなたのお財布とkCoinを操作できます。',
...
HELP_0_Desc_1               : 'Kowala Wallet Tools gives you the ability to generate new wallets so you can store your kCoin yourself, not on an exchange. This process happens entirely on your computer, not our servers. Therefore, when you generate a new wallet, **you are responsible for safely backing it up**.',
...
HELP_0_Desc_5               : 'Transfer kCoin to this new wallet.',
...
HELP_2a_Desc_3              : 'Save versions of the private key. Do not share it with anyone else. Your private key is necessary when you want to access your kCoin to send it! There are 3 types of private keys:',
...
HELP_2b_Title               : '2b) How do I safely / offline / cold storage with Kowala Wallet Tools?',
...
HELP_3_Desc_1               : '**Before you send any kCoin to your new wallet**, you should ensure you have access to it.',
HELP_3_Desc_2               : 'Navigate to the "View Wallet Info" page.',
HELP_3_Desc_3               : 'Navigate to the Kowala Wallet Tools "View Wallet Info" page.',
...
HELP_4_Title                : '4) How do I send kCoin from one wallet to another?',
...
HELP_4_Desc_2               : 'Navigate to the "kCoin送出 トークン送出" page.',
...
HELP_4CX_Title              : '4) How do I send kCoin using Kowala Wallet Tools CX?',
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "kCoin送出 トークン送出" page.',
...
HELP_4CX_Desc_12            : 'Using "kCoin送出 トークン送出" Page',
HELP_5_Title                : '5) How do I run Kowala Wallet Tools offline/locally?',
HELP_5_Desc_1               : 'You can run Kowala Wallet Tools on your computer instead of from the GitHub servers. You can generate a wallet completely offline and send transactions from the "Offline Transaction" page.',
HELP_5_Desc_7               : 'Kowala Wallet Tools is now running entirely on your computer.',
HELP_5_Desc_8               : 'In case you are not familiar, you need to keep the entire folder in order to run the website, not just `index.html`. Don\'t touch or move anything around in the folder. If you are storing a backup of the Kowala Wallet Tools repo for the future, we recommend just storing the ZIP so you can be sure the folder contents stay intact.',
HELP_5_Desc_9               : 'As we are constantly updating Kowala Wallet Tools, we recommend you periodically update your saved version of the repo.',
...
HELP_7_Desc_1               : 'Navigate to the "kCoin送出 トークン送出" page.',
...
HELP_8_Desc_1               : 'Kowala Wallet Tools is not a web wallet. You don\'t have a login and nothing ever gets saved to our servers. It is simply an interface that allows you interact with the blockchain.',
HELP_8_Desc_2               : 'If Kowala Wallet Tools goes down, you would have to find another way (like geth or Kowala Wallet / Mist) to do what we are doing. But you wouldn\'t have to "get" your kCoin out of Kowala Wallet Tools because it\'s not in Kowala Wallet Tools. It\'s in whatever wallet your generated via our site.',
HELP_8_Desc_3               : 'You can import your unencrypted private key and your Geth/Mist Format (encrypted) files directly into geth / Kowala Wallet / Mist very easily now. See question #12 below.',
HELP_8_Desc_4               : 'In addition, the likelihood of us taking Kowala Wallet Tools down is slim to none. It costs us almost nothing to maintain as we aren\'t storing any information. If we do take the domain down, it still is, and always will be, publicly available at [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). You can download the ZIP there and run it locally.',
HELP_8CX_Title              : '8) What happens if Kowala Wallet Tools CX disappears?',
...
HELP_8CX_Desc_2             : 'That said, it is **very important** that you back up all your information for any new wallets generated with Kowala Wallet Tools CX. That way if anything happens to Kowala Wallet Tools CX or your computer, you still have all the information necessary to access your kCoin. See the #2a for how to back up your wallets.',
HELP_8CX_Desc_3             : 'If for some reason Kowala Wallet Tools CX disappears from the Chrome Store, you can find the source on Github and load it manually. See #5 above.',
HELP_9_Title                : '9) Is the "kCoin送出 トークン送出" page offline?',
...
HELP_12_Title               : '12) How do I import a wallet created with Kowala Wallet Tools into geth / Kowala Wallet / Mist?',
HELP_12_Desc_1              : 'Using an Geth/Mist JSON file from Kowala Wallet Tools v2+....',
...
HELP_12_Desc_7              : 'Open the Kowala Wallet application.',
...
HELP_12_Desc_20             : 'This will prompt you to make a new password. This is the password you will use in geth / Kowala Wallet / Mist whenever you send a transaction, so don\'t forget it.',
HELP_12_Desc_21             : 'After successful import, delete `nothing_special_delete_me.txt`',
HELP_12_Desc_22             : 'The next time you open the Kowala Wallet application, your account will be listed under "Accounts".',
...
HELP_12_Desc_26             : 'This will prompt you to make a new password. This is the password you will use in geth / Kowala Wallet / Mist whenever you send a transaction, so don\'t forget it.',
HELP_12_Desc_27             : 'After successful import, delete `nothing_special_delete_me.txt`',
HELP_12_Desc_28             : 'The next time you open the Kowala Wallet application, your account will be listed under "Accounts".',
...
HELP_13_Desc_1              : 'This means you do not have enough kCoin in your account to cover the cost of gas. Each transaction (including token and contract transactions) require gas and that gas is paid in kCoin. The number displayed is the amount required to cover the cost of the transaction in Wei. Take that number, divide by `1000000000000000000`, and subtract the amount of kCoin you were trying to send (if you were attempting to send kCoin). This will give you the amount of kCoin you need to send to that account to make the transaction.',
HELP_14_Title               : '14) Some sites randomize (seed) the private key generation via mouse movements. Kowala Wallet Tools doesn\'t do this. Is the random number generation for Kowala Wallet Tools safe?',
HELP_14_Desc_1              : 'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experiments) believe in window.crypto. In addition, Kowala Wallet Tools can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto).',
HELP_15_Title               : '15) Why hasn\'t the account I just created show up in the blockchain explorer? (ie: etherchain, etherscan)',
HELP_15_Desc_1              : 'Accounts will only show up in a blockchain explorer once the account has activity on it&mdash;for example, once you have transferred some kCoin to it.',
...
HELP_21_Desc_2              : 'Long ELI5 Version: So Kowala is based on [Public Key Cryptography](https://en.wikipedia.org/wiki/Public-key_cryptography), specifically [Elliptic curve cryptography](https://eprint.iacr.org/2013/734.pdf) which is very widely used, not just in Kowala. Most servers are protected via ECC. Bitcoin uses the same, as well as SSH and TLS and a lot of other stuff. The Kowala keys specifically are 256-bit keys, which are stronger than 128-bit and 192-bit, which are also widely used and still considered secure by experts.',
...
HELP_21_Desc_8              : 'Of course, this all assumes that keys are generated in a truly random way & with sufficient entropy. The keys generated here meet that criteria, as do Jaxx and Mist/geth. The Kowala wallets are all pretty good. Keys generated by brainwallets do not, as a person\'s brain is not capable of creating a truly random seed. There have been a number of other issues regarding lack of entropy or seeds not being generated in a truly random way in Bitcoin-land, but that\'s a separate issue that can wait for another day.',
...
HELP_Remind_Desc_1          : '**Kowala, Kowala Wallet Tools & Kowala Wallet Tools CX, and some of the underlying Javascript libraries we use are under active development.** While we have thoroughly tested & tens of thousands of wallets have been successfully created by people all over the globe, there is always the remote possibility that something unexpected happens that causes your ETH to be lost. Please do not invest more than you are willing to lose, and please be careful. If something were to happen, we are sorry, but **we are not responsible for the lost kCoin**.',
HELP_Remind_Desc_2          : 'Kowala Wallet Tools & Kowala Wallet Tools CX are not "web wallets". You do not create an account or give us your kCoin to hold onto. All data never leaves your computer/your browser. We make it easy for you to create, save, and access your information and interact with the blockchain.',
...
HELP_SecCX_Title            : 'Security - Kowala Wallet Tools CX',
...
HELP_SecCX_Desc_6           : 'If we were to encrypt these items, you would need to enter a password each time you wanted to view your account balance or view the nicknames. If this concerns you, we recommend you use Kowala Wallet Tools instead of this Chrome Extension.',
