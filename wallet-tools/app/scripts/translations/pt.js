...
X_HelpfulLinks_4                :  'Migrando para/de Kowala Wallet Tools',
...
NAV_SendkCoin               : 'Enviar kCoin & Tokens ',
...
MEW_Tagline                 : 'Fonte aberta JavaScript para o client-side da Carteira kCoin ',
CX_Tagline                  : 'Fonte Aberta JavaScript para o client-side da Carteira kCoin para extensão do Chrome ',

/* Footer */
FOOTER_1                    : 'Uma fonte aberta, javascript, ferramenta do client-side para gerar Carteiras Kowala & envio de transações. ',
...
sidebar_donation            : 'Kowala Wallet Tools é grátis, um serviço de fonte aberta dedicado a sua privacidade e segurança. Quanto mais doações nós recebermos, mais podemos gastar criando novidade, ouvindo seu feedback, e entregando o que você deseja. Somos apenas duas pessoas tentando mudar o mundo. Ajude-nos? ',
sidebar_donate              : 'De ',
...
ADD_Warning_1               : 'Você pode adicionar qualquer conta para "ver" na tab de carteiras sem fazer o upload da chave privada. Isso significa que você ** não **  tem acesso a essa carteira, nem pode transferir kCoin a partir dela. ',
...
MYWAL_Content_3             : 'Se pretender utilizar esta carteira com o Kowala Wallet Tools CX no futuro, terá de voltar a adicioná-la manualmente utilizando a chave privada/JSON e a palavra-passe. ',
...
ADD_Ledger_2                : 'Abra a aplicação Kowala (ou uma aplicação de contrato) ',
...
ADD_Ledger_0a               : 'Re-abra Kowala Wallet Tools em uma conexão (SSL) segura ',
ADD_Ledger_0b               : 'Re-abra Kowala Wallet Tools usando [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Re-abra Kowala Wallet Tools em uma conexão (SSL) segura ',
ADD_DigitalBitbox_0b        : 'Re-abra Kowala Wallet Tools usando [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/) ',
...
HELP_4_Desc_2               : 'Navigate to the "Enviar kCoin & Tokens" page. ',
...
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Enviar kCoin & Tokens" page. ',
...
HELP_4CX_Desc_12            : 'Using "Enviar kCoin & Tokens" Page ',
...
HELP_7_Desc_1               : 'Navigate to the "Enviar kCoin & Tokens" page. ',
...
HELP_9_Title                : '9) Is the "Enviar kCoin & Tokens" page offline? ',
