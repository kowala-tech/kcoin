...
tx_notFound_4               : 'Veuillez utiliser le menu déroulant en haut à droite & sélectionner un nœud ETH différent (par ex. `ETH (kCoinscan.io)` ou `ETH (Infura.io)` ou `ETH (Kowala Wallet Tools)`) et revérifiez.',
...
GEN_Help_12                 : 'Utilisez-le pour déverouiller votre portefeuille avec Kowala Wallet Tools (ou Mist, Geth, Parity et autres wallet clients.) ',
...
/* Header */
CX_Tagline                  : 'EKSTANSYON CHROME BOUS d\'kCoin Open Source JavaScript POU KLIYAN  AN ',
...
MEW_Tagline                 : 'BOUS d\'kCoin Open Source JavaScript POU KLIYAN AN ',
...
MYWAL_Content_3             : 'SI W’ VLE SÈVI AK BOUS SA  AVÈK Kowala Wallet Tools CX NAN LÒT JOU YO, OU DWE METE L’ ANKÒ  SÈVI AK KLE SEKRÈ A /PAJ JSON AK KÒD SEKRÈ A ',
...
HELP_SecCX_Desc_6           : 'SI NOU TA DWE METE KÒD NAN ENFÒMASYON YO, FÒK OU TA ANTRE YON KÒD SEKRÈ NAN CHAK MOMAN OU BEZWEN WÈ LAJAN SOU KONT OU OSWA LÒT TI NON YO. SI SA NWI W’,NOU MANDE W’ POU SÈVI AK Kowala Wallet Tools KE EXTENSION CHROME SA. ',
