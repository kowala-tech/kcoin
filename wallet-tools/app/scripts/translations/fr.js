...
tx_notFound_4               : 'Veuillez utiliser le menu déroulant en haut à droite & sélectionner un nœud ETH différent (par ex. `ETH (kCoinscan.io)`, `ETH (Infura.io)` ou `ETH (Kowala Wallet Tools)`) puis revérifiez.',
...
GEN_Help_12                 : 'Utilisez-le pour déverouiller votre portefeuille avec Kowala Wallet Tools (ou Mist, Geth, Parity et autres clients.) ',
...
NAV_SendkCoin               : 'Envoyer des kCoin et des Tokens ',
...
/* General */
x_Access                    : 'Accès ',
x_AddessDesc                : 'Aussi appelée `adresse` ou `clé publique`. C\'est ce que vous donnez aux gens pour qu\'ils puissent vous envoyer des kCoin ou des Tokens. Remarquez l\'icône colorée. Cette icône doit être identique quand vous entrez votre adresse quelque part.', //Find the colorful address icon. Make sure it matches your paper wallet & whenever you enter your address somewhere. Cette icône est une façon simple de reconnaître votre adresse.
x_Address                   : 'Votre adresse ',
x_Cancel                    : 'Annuler ',
x_CSV                       : 'Fichier CSV (non-chiffré) ',
x_Download                  : 'Télécharger ',
x_Json                      : 'Fichier JSON (non-chiffré) ',
x_JsonDesc                  : 'C\'est la version non-chiffrée au format JSON de votre clé privée. Cela signifie que vous n\'avez pas besoin de votre mot de passe pour l\'utiliser mais que toute personne qui trouve ce JSON peut accéder à votre portefeuille et vos kCoin sans mot de passe. ',
...
MEW_Tagline                 : 'Portefeuille d\'kCoin Open Source, écrit en JavaScript',
CX_Tagline                  : 'Extension Chrome de portefeuille d\'kCoin Open Source JavaScript',

/* Footer */
FOOTER_1                    : 'Un outil open source, écrit en Javascript, qui permet de générer des portefeuilles Kowala et d\'envoyer des transactions. ',
FOOTER_1b                   : 'Créé par ',
...
ADD_Warning_1               : 'Vous pouvez ajouter n\'importe quel compte pour l\'afficher dans l\'onglet "portefeuilles" sans uploader une clé privée. Cela ne veut **pas** dire que vous aurez accès à ce portefeuille, ni que vous pouvez transférer des kCoin depuis ce portefeuille. ',
...
SENDModal_Content_4         : 'NOTE : Si vous renontrez une erreur, il est très probable que vous deviez ajouter des kCoin à votre compte pour couvrir les coûts (en GAS) d\'envoi des Tokens. Le GAS est payé en kCoin.',
...
MYWAL_Content_3             : 'Si vous voulez utiliser ce portefeuille avec Kowala Wallet Tools CX à l\'avenir, vous devrez le rajouter manuellement en utilisant la clé privée / fichier JSON et le mot de passe.',
...
ADD_Ledger_2                : 'Ouvrez l\'application Kowala (ou une application de contrat)',
...
ADD_Ledger_0a               : 'Rouvrir Kowala Wallet Tools sur une connexion sécurisée (SSL)',
ADD_Ledger_0b               : 'Rouvrir Kowala Wallet Tools avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/)',
...
ADD_DigitalBitbox_0a        : 'Rouvrir Kowala Wallet Tools sur une connexion sécurisée (SSL)',
ADD_DigitalBitbox_0b        : 'Rouvrir Kowala Wallet Tools avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/)',
...
NODE_Warning                : 'Votre nœud doit être en HTTPS pour vous y connecter via Kowala Wallet Tools. Vous pouvez [télécharger Kowala Wallet Tools et le lancer localement](https://github.com/kvhnuke/etherwallet/releases/latest) pour vous connecter à un nœud quelconque, ou obtenir un certificat SSL gratuit via [LetsEncrypt](https://letsencrypt.org/)',
...
HELP_0_Desc_5               : 'Transférez de l\'kCoin vers ce nouveau portefeuille.',
...
HELP_2a_Desc_2              : 'Sauvegardez l\'adresse. Vous pouvez la garder pour vous-même ou la partager avec d\'autres personnes qui, de cette manière, peuvent vous envoyer de l\'kCoin.',
HELP_2a_Desc_3              : 'Sauvegardez votre clef privée en plusieurs exemplaires. Ne la partagez avec personne. Votre clef privée est nécessaire pour accéder à votre kCoin et pour l\'envoyer ! Il existe 3 types de clef privée :',
...
HELP_2b_Title               : '2b) Comment puis-je gérer en toute sécurité un stockage hors ligne avec Kowala Wallet Tools ?',
...
HELP_3_Desc_1               : '**Avant d\'envoyer de l\'kCoin à votre portefeuille**, vous devez vous assurer que vous y avez accès.',
HELP_3_Desc_2               : 'Naviguez vers la page "Visualisation d\'un portefeuille".',
HELP_3_Desc_3               : 'Naviguez vers la page Visualisation d\'un portefeuille" de Kowala Wallet Tools.',
...
HELP_3_Desc_8               : 'Si vous désirez détenir une grande quantité d\'kCoin, nous recommandons de commencer par envoyer une petite somme depuis le nouveau portefeuille avant d\'y déposer une somme importante. Envoyez 0,001 kCoin vers le nouveau portefeuille, accédez-y puis envoyez ces 0,001 kCoin vers une autre adresse, et vérifiez que tout a fonctionné sans encombre.',

HELP_4_Title                : '4) Comment puis-je envoyer de l\'kCoin d\'un portefeuille vers un autre ?',
HELP_4_Desc_1               : 'Si vous désirez transférer une grande quantité d\'kCoin, vous devez d\'abord essayer d\'en envoyer un petit montant vers votre portefeuille pour vous assurer que tout fonctionne comme prévu.',
HELP_4_Desc_2               : 'Naviguez vers la page "Envoyer des kCoin et des Tokens".',
...
HELP_4CX_Title              : '4) Comment puis-je envoyer de l\'kCoin avec Kowala Wallet Tools CX ?',
HELP_4CX_Desc_1             : 'D\'abord, vous devez ajouter un portefeuille. Ceci fait, deux possibilités s\'offrent à vous : la fonctionnalité "Envoi rapide" de l\'icône de l\'extension Chrome ou la page "Envoyer des kCoin et des Tokens".',
...
HELP_4CX_Desc_5             : 'Sélectionnez le portefeuille d\'où vous désirez envoyer les kCoins.',
...
HELP_4CX_Desc_12            : 'Avec la page "Envoyer des kCoin et des Tokens" ',

HELP_5_Title                : '5) Comment puis-je lancer Kowala Wallet Tools hors ligne (en local) ?',
HELP_5_Desc_1               : 'Vous pouvez lancer Kowala Wallet Tools sur votre ordinateur au lieu de passer par les serveurs GitHub. Vous pouvez générer un portefeuille en restant totalement hors ligne et envoyer des transactions depuis la page "Transaction hors ligne".',
HELP_5_Desc_7               : 'Kowala Wallet Tools tourne maintenant complètement sur votre ordinateur.',
HELP_5_Desc_8               : 'Au cas où cela ne vous est pas familier, vous devez conserver l\'intégralité du dossier pour faire tourner le site web et non uniquement `index.html`. Ne touchez à rien, ne déplacez rien dans le dossier. Si vous stockez une sauvegarde du repo Kowala Wallet Tools pour l\'avenir, nous vous recommandons de ne stocker que le ZIP afin d\'être sûr que le contenu du dossier restera intact.',
HELP_5_Desc_9               : 'Comme nous améliorons constamment Kowala Wallet Tools, nous vous recommandons de mettre régulièrement à jour votre version de sauvegarde.',
...
HELP_8_Desc_1               : 'Kowala Wallet Tools n\'est pas un portefeuille web. Vous n\'avez pas de compte dessus et rien n\'est jamais stocké sur nos serveurs. Ce n\'est qu\'une interface qui vous permet d\'interagir avec le blockchain.',
HELP_8_Desc_2               : 'Si Kowala Wallet Tools venait à être hors ligne, vous devrez trouver un autre moyen (comme Geth ou Kowala Wallet / Mist) pour faire la même chose. Mais vous n\'aurez pas à "récupérer" votre kCoin depuis Kowala Wallet Tools parce qu\'il ne se trouve pas dans Kowala Wallet Tools. Il est chez vous, dans le portefeuille que vous avez généré par notre site.',
HELP_8_Desc_3               : 'Vous pouvez maintenant importer facilement votre clef privée non chiffrée et vos fichiers (chiffrés) au format Geth/Mist, directement dans geth / Kowala Wallet / Mist. Voir question #12 ci-dessous.',
HELP_8_Desc_4               : 'De plus, la probabilité que nous laissions tomber Kowala Wallet Tools approche zéro. Il ne nous coûte presque rien de le maintenir comme nous n\'y stockons aucune information. Si le domaine venait à être perdu, le logiciel sera toujours disponible publiquement sur [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Vous pourrez y télécharger le ZIP et le faire tourner localement.',

HELP_8CX_Title              : '8) Que se passe-t-il si Kowala Wallet Tools CX disparaît ?',
...
HELP_8CX_Desc_2             : 'Cela dit, il est **très important** que vous sauvegardiez toutes les données de tous les portefeuilles générés par Kowala Wallet Tools CX. De cette manière, si quoi que ce soit arrivait à Kowala Wallet Tools CX ou à votre ordinateur, vous conserveriez toutes les informations nécessaires pour accéder à votre kCoin. Voir #2a pour la sauvegarde de vos portefeuilles.',
HELP_8CX_Desc_3             : 'Si, pour une raison quelconque, Kowala Wallet Tools CX disparaissait du Chrome Store, vous pourrez en trouver le source sur [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages) et le charger manuellement. Voir #5 ci-dessus.',

HELP_9_Title                : '9) La page "Envoyer des kCoin et des Tokens" est-elle hors ligne ? ',
HELP_9_Desc_1               : 'Non. Elle a besoin de l\'internet pour obtenir le prix actuel du Gas, le nonce de votre compte et pour émettre la transaction (c\'est-à-dire "envoyer des kCoins"). Cependant, elle n\'envoie que la transaction signée. Votre clef privée reste en sécurité chez vous. Nous fournissons aussi une page "Transaction hors ligne" pour vous permettre de conserver en permanence vos clefs privées sur une machine hors ligne.',
...
HELP_10_Desc_11             : 'Sur votre ordinateur en ligne, collez la transaction signée dans le champ texte et cliquez sur "Envoyez l\'kCoin". Ceci émettra votre transaction. ',
HELP_12_Title               : '12) Comment puis-je importer un portefeuille créé par Kowala Wallet Tools dans geth, Kowala Wallet ou Mist ?',
HELP_12_Desc_1              : 'Avec un fichier Geth/Mist JSON de Kowala Wallet Tools v2+.... ',
...
HELP_12_Desc_7              : 'Ouvrez l\'application Kowala Wallet. ',
...
HELP_12_Desc_20             : 'Ceci vous invitera à choisir un nouveau mot de passe. C\'est celui que vous utiliserez dans geth / Kowala Wallet / Mist à chaque vois que vos créerez une transaction, alors ne l\'oubliez pas. ',
HELP_12_Desc_21             : 'Après que l\'import ait réussi, supprimez `nothing_special_delete_me.txt` ',
HELP_12_Desc_22             : 'La prochaine fois que vous ouvrirez l\'application Kowala Wallet, votre compte sera listé sous "Accounts". ',
...
HELP_12_Desc_26             : 'Ceci vous invitera à choisir un nouveau mot de passe. C\'est celui que vous utiliserz dans geth / Kowala Wallet / Mist à chaque foiq que vous créerez une transaction, alors ne l\'oubliez pas. ',
HELP_12_Desc_27             : 'Après que l\'import ait réussi, supprimez `nothing_special_delete_me.txt` ',
HELP_12_Desc_28             : 'La prochaine fois que vous ouvrirez l\'application Kowala Wallet, votre compte sera listé sous "Accounts". ',
...
HELP_13_Desc_1              : 'Cela signifie que vous n\'avez pas assez d\'kCoin sur votre compte pour couvrir les coûts en Gas. Chaque transaction (y compris pour les tokens et les contrats) demande du Gas, et ce Gas est payé en kCoin. Le nombre affiché est le montant requis pour couvrir le coût de la transaction en Wei. Prenez ce nombre, divisez-le par `10^18` (soit `1000000000000000000`) et soustrayez la somme en kCoin que vous essayiez d\'envoyer (si vous tentiez d\'envoyer de l\'kCoin). Cela vous donnera le montant en kCoin que vous avez besoin d\'ajouter à votre compte pour effectuer cette transaction.',

HELP_14_Title               : '14) Certains sites initialisent la génération de clef privée par les mouvements de la sours. Ce n\'est pas le cas de Kowala Wallet Tools. La génération de nombres aléatoires de Kowala Wallet Tools est-elle sûre ?',
HELP_14_Desc_1              : 'Bien que l\'interception des mouvement de la souris soit jugée attractive par beaucoup, et que nous en comprenions les raisons, la réalité est que window.crypto assure plus d\'entropie que les mouvements de votre souris. L\'utilisation de ces mouvements est sûre mais nous (ainsi que de nombreux projets crypto) avons de bonnes raisons de croire en window.crypto. De plus, Kowala Wallet Tools peut être utilisé sur des périphériques tactiles. Voici une [conversation entre un redditeur rageur et Vitalik Buterin à propos des mouvements de souris et window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) et voici [les spécifications w3 de window.crypto](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto).',
...
HELP_15_Desc_1              : 'Les comptes n\'apparaissent dans un explorateur de blockchain qu\'après une activité, comme par exemple, un envoi ou une réception d\'kCoin.',
...
HELP_21_Desc_2              : 'Version longue : Kowala est basé sur la [Cryptographie asymétrique](https://fr.wikipedia.org/wiki/Cryptographie_asymétrique), plus précisément la [cryptographie des courbes elliptiques (ECC)](https://eprint.iacr.org/2013/734.pdf) qui est très couramment employée, non pas uniquement dans Kowala. La plupart des serveurs sont protégés par les ECC. Bitcoin les emploie, ainsi que SSH, TLS et bien d\'autres protocoles. Dans le cas spécifique d\'Kowala, les clefs font 256 bits et sont plus fortes que celles en 128 et 192 bits, encore très employées et toujours considérées comme sûres par les experts.',
HELP_21_Desc_3              : 'Vous avez une clef privée et une clef publique. La clef privée peut servir à dériver la clef publique mais l\'inverse est pratiquement impossible. Le fait que l\'internet et le monde entier utilise ce système cryptographique signifie que, s\'il existait un moyen de dériver la clef privée de la clef publique, le risque que courrait votre kCoin serait le dernier de vos soucis.',
HELP_21_Desc_4              : 'Cela dit, OUI : si quelqu\'un possède votre clef privée, il peut envoyer de l\'kCoin depuis votre compte, de même que si une personne a le mot de passe de votre email, elle peut lire des mails ou en envoyer, ou si c\'est le mot de passe de votre compte en banque, elle peut faire des virements. Vous pouvez télécharger la versoin Keystore de votre clef privée qui est la clef privée chiffrée avec un mot de passe. Cela ressemble à avoir un mot de passe protégé par un autre mot de passe.',
...
HELP_SecCX_Desc_6           : 'Si nous devions chiffrer ces informations, il vous faudrait entrer un mot de passe à chaque fois que vous voudriez voir votre solde ou les surnoms. Si cela vous ennuie, nous vous recommandons d\'utiliser Kowala Wallet Tools au lieu de cette extension Chrome.',
