...
var swapCtrl = function ($scope, $sce, walletService) {
  ...
  */
  ...
  $scope.parseKyberSignedTransaction = function (signedTx) {
    ...
    parsedKyberTx.value = (txData.value == '0x' || txData.value == '' || txData.value == null) ? '0' : etherUnits.tokCoin(new BigNumber(ethFuncs.sanitizeHex(txData.value.toString('hex'))).toString(), 'wei')
    ...
    parsedKyberTx.gasPrice.eth = etherUnits.tokCoin(new BigNumber(ethFuncs.sanitizeHex(txData.gasPrice.toString('hex'))).toString(), 'wei')
    ...
    parsedKyberTx.txFee.eth = etherUnits.tokCoin(parseInt(parsedKyberTx.txFee.wei), 'wei').toString()
